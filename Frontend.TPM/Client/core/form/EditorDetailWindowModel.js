Ext.define('Core.form.EditorDetailWindowModel', {
    ...
    saveModel: function (model, callback) {
        ...
        if (model.id.indexOf("App.model.tpm.assortmentmatrix.AssortmentMatrix") != -1) {
            var manager = Ext.ux.data.BreezeEntityManager.getEntityManager();
            var entityType = manager.metadataStore.getEntityType("AssortmentMatrix");
