Ext.define('App.model.core.filesendinterfacesetting.HistoricalFileSendInterfaceSetting', {
    ...
    fields: [
		...
		{ name: '_EditDate', type: 'date', isDefault: true, extendedFilterEntry: App.extfilter.core.ConfigSource.getEntryConfig('HistoricalFileSendInterfaceSetting', '_EditDate', 'date') },
