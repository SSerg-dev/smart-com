Ext.define('App.model.core.csvprocessinterfacesetting.HistoricalCSVProcessInterfaceSetting', {
    ...
    fields: [
		...
		{ name: '_EditDate', type: 'date', isDefault: true, extendedFilterEntry: App.extfilter.core.ConfigSource.getEntryConfig('HistoricalCSVProcessInterfaceSetting', '_EditDate', 'date') },
