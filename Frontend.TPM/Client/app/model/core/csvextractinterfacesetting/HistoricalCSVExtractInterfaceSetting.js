Ext.define('App.model.core.csvextractinterfacesetting.HistoricalCSVExtractInterfaceSetting', {
    ...
    fields: [
        ...
        { name: '_EditDate', type: 'date', isDefault: true, extendedFilterEntry: App.extfilter.core.ConfigSource.getEntryConfig('HistoricalCSVExtractInterfaceSetting', '_EditDate', 'date'), timeZone: +3, convert: dateConvertTimeZone },
