Ext.define('App.view.core.common.CombinedDirectoryPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.combineddirectorypanel',
    mixins: {
    ...
    getBaseModel: function (exactryModel) {
        var model = Ext.ModelManager.getModel(this.down('grid').getStore().model);
