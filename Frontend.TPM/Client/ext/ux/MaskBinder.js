...
Ext.define('Ext.ux.MaskBinder', {
    ...
    init: function (grid) {
        ...
        Ext.apply(grid, {
            maskBinder: this//, 
            //setMask: Ext.bind(this.setMask, this),
            //unsetMask: Ext.bind(this.unsetMask, this)
        });
    },
    ...
    setMask: function () {
        ...
        if (targetEl && this.needShowMask) {
            targetEl.mask(this.msg);
        }
    },
    ...
    disableShowMask: function(disable) {
        this.needShowMask = !disable;
    },
