...
Ext.define('Ext.ux.Spotlight', {
    ...
    createElements: function () {
        ...
        if (active) {
            style.zIndex += active.getEl().dom.style['zIndex'];
        }
        ...
        me.right.on('click', this.onChildElementClick, this);
        me.left.on('click', this.onChildElementClick, this);
        me.top.on('click', this.onChildElementClick, this);
        me.bottom.on('click', this.onChildElementClick, this);

        me.all = Ext.create('Ext.CompositeElement', [me.right, me.left, me.top, me.bottom]);
    },

    onChildElementClick: function () {
