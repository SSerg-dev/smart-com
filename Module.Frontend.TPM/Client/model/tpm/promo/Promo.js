Ext.define('App.model.tpm.promo.Promo', {
    ...
    fields: [
        ...
        { name: 'ManualInputSumInvoice', type: 'bool', hidden: true, isDefault: false, defaultValue: false },
        ...
        //COGS/Tn
        { name: 'PlanPromoIncrementalMACLSV', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'PlanPromoNetIncrementalMACLSV', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'ActualPromoIncrementalMACLSV', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'ActualPromoNetIncrementalMACLSV', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'PlanPromoIncrementalEarningsLSV', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'PlanPromoNetIncrementalEarningsLSV', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'ActualPromoNetIncrementalEarningsLSV', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'ActualPromoIncrementalEarningsLSV', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'PlanPromoROIPercentLSV', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'PlanPromoNetROIPercentLSV', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'ActualPromoROIPercentLSV', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'ActualPromoNetROIPercentLSV', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'IsLSVBased', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'PlanPromoBaselineVolume', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'PlanPromoPostPromoEffectVolume', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'PlanPromoPostPromoEffectVolumeW1', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'PlanPromoPostPromoEffectVolumeW2', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'PlanPromoIncrementalVolume', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'PlanPromoNetIncrementalVolume', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'ActualPromoBaselineVolume', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'ActualPromoPostPromoEffectVolume', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'ActualPromoVolumeByCompensation', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'ActualPromoVolumeSI', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'ActualPromoVolume', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'ActualPromoIncrementalVolume', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'ActualPromoNetIncrementalVolume', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'PlanPromoIncrementalCOGSTn', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'PlanPromoNetIncrementalCOGSTn', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'ActualPromoIncrementalCOGSTn', useNull: true, type: 'float', hidden: true, isDefault: false },
        { name: 'ActualPromoNetIncrementalCOGSTn', useNull: true, type: 'float', hidden: true, isDefault: false },
