Ext.define('App.model.tpm.promo.Promo', {
    ...
    fields: [
        ...
        { name: 'TechnologyName', type: 'string', mapping: 'BrandTech.Technology.Name', defaultFilterConfig: { valueField: 'Name' }, breezeEntityType: 'Technology', hidden: false, isDefault: true },
