Ext.define('App.view.tpm.promo.HistoricalUserRolePromo', {
    extend: 'App.view.core.common.CombinedDirectoryPanel',
    alias: 'widget.historicaluserrolepromo',
    ...
    items: [{
        ...
        store: {
            type: 'directorystore',
            model: 'App.model.tpm.promo.HistoricalUserRolePromo',
            storeId: 'historicaluserrolepromostore',
            extendedFilter: {
        ...
        columns: {
            ...
            items: [
            {
                text: l10n.ns('tpm', 'HistoricalUserRolePromo').value('_User'),
                dataIndex: '_User',
                filter: {
                    type: 'string',
                    operator: 'eq'
                ...
                text: l10n.ns('tpm', 'HistoricalUserRolePromo').value('_Role'),
                dataIndex: '_Role',
                filter: {
                    type: 'string',
                    operator: 'eq'
                ...
                text: l10n.ns('tpm', 'HistoricalUserRolePromo').value('_EditDate'),
                dataIndex: '_EditDate',
                xtype: 'datecolumn',
                renderer: Ext.util.Format.dateRenderer('d.m.Y H:i:s')
            }, {
                text: l10n.ns('tpm', 'HistoricalUserRolePromo').value('_Operation'),
