    ...
    items: [{
        ...
        columns: {
            ...
            items: [
                ...
                { text: l10n.ns('tpm', 'PromoROIReport').value('PCPrice'), dataIndex: 'PCPrice', format: '0.00' },
                ...
                { text: l10n.ns('tpm', 'PromoROIReport').value('TIBasePercent'), dataIndex: 'TIBasePercent', format: '0.00' },
                { text: l10n.ns('tpm', 'PromoROIReport').value('PlanPromoIncrementalBaseTI'), dataIndex: 'PlanPromoIncrementalBaseTI', format: '0.00' },
                { text: l10n.ns('tpm', 'PromoROIReport').value('PlanPromoNetIncrementalBaseTI'), dataIndex: 'PlanPromoNetIncrementalBaseTI', format: '0.00' },
                { text: l10n.ns('tpm', 'PromoROIReport').value('COGSPercent'), dataIndex: 'COGSPercent', format: '0.00' },
                { text: l10n.ns('tpm', 'PromoROIReport').value('PlanPromoIncrementalCOGS'), dataIndex: 'PlanPromoIncrementalCOGS', format: '0.00' },
                { text: l10n.ns('tpm', 'PromoROIReport').value('PlanPromoNetIncrementalCOGS'), dataIndex: 'PlanPromoNetIncrementalCOGS', format: '0.00' },
                ...
                { text: l10n.ns('tpm', 'PromoROIReport').value('PlanPromoNetBaseTI'), dataIndex: 'PlanPromoNetBaseTI', format: '0.00' },
                { text: l10n.ns('tpm', 'PromoROIReport').value('PlanPromoNSV'), dataIndex: 'PlanPromoNSV', format: '0.00' },
                ...
                { text: l10n.ns('tpm', 'PromoROIReport').value('ActualPromoNetUpliftPercent'), dataIndex: 'ActualPromoNetUpliftPercent', format: '0.00' },
                ...
                { text: l10n.ns('tpm', 'PromoROIReport').value('ActualPromoNetIncrementalBaseTI'), dataIndex: 'ActualPromoNetIncrementalBaseTI', format: '0.00' },
                { text: l10n.ns('tpm', 'PromoROIReport').value('ActualPromoIncrementalCOGS'), dataIndex: 'ActualPromoIncrementalCOGS', format: '0.00' },
                { text: l10n.ns('tpm', 'PromoROIReport').value('ActualPromoNetIncrementalCOGS'), dataIndex: 'ActualPromoNetIncrementalCOGS', format: '0.00' },
                ...
                { text: l10n.ns('tpm', 'PromoROIReport').value('ActualPromoNetBaseTI'), dataIndex: 'ActualPromoNetBaseTI', format: '0.00' },
                { text: l10n.ns('tpm', 'PromoROIReport').value('ActualPromoNSV'), dataIndex: 'ActualPromoNSV', format: '0.00' },
