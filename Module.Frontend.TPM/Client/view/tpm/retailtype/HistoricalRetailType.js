Ext.define('App.view.tpm.retailtype.HistoricalRetailType', {
    extend: 'App.view.core.common.CombinedDirectoryPanel',
    alias: 'widget.historicalretailtype',
    ...
    items: [{
        ...
        store: {
            type: 'directorystore',
            model: 'App.model.tpm.retailtype.HistoricalRetailType',
            storeId: 'historicalretailtypestore',
            extendedFilter: {
        ...
        columns: {
            ...
            items: [{
                text: l10n.ns('tpm', 'HistoricalRetailType').value('_User'),
                dataIndex: '_User',
                filter: {
                    type: 'string',
                    operator: 'eq'
                ...
                text: l10n.ns('tpm', 'HistoricalRetailType').value('_Role'),
                dataIndex: '_Role',
                filter: {
                    type: 'string',
                    operator: 'eq'
                ...
                text: l10n.ns('tpm', 'HistoricalRetailType').value('_EditDate'),
                dataIndex: '_EditDate',
                xtype: 'datecolumn',
                renderer: Ext.util.Format.dateRenderer('d.m.Y H:i:s')
            }, {
                text: l10n.ns('tpm', 'HistoricalRetailType').value('_Operation'),
