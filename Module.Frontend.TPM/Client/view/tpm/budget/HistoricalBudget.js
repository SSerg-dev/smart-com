Ext.define('App.view.tpm.budget.HistoricalBudget', {
    extend: 'App.view.core.common.CombinedDirectoryPanel',
    alias: 'widget.historicalbudget',
    ...
    items: [{
        ...
        store: {
            type: 'directorystore',
            model: 'App.model.tpm.budget.HistoricalBudget',
            storeId: 'historicalbudgetstore',
            extendedFilter: {
        ...
        columns: {
            ...
            items: [
            {
                text: l10n.ns('tpm', 'HistoricalBudget').value('_User'),
                dataIndex: '_User',
                filter: {
                    type: 'string',
                    operator: 'eq'
                ...
                text: l10n.ns('tpm', 'HistoricalBudget').value('_Role'),
                dataIndex: '_Role',
                filter: {
                    type: 'string',
                    operator: 'eq'
                ...
                text: l10n.ns('tpm', 'HistoricalBudget').value('_EditDate'),
                dataIndex: '_EditDate',
                xtype: 'datecolumn',
                renderer: Ext.util.Format.dateRenderer('d.m.Y H:i:s')
            }, {
                text: l10n.ns('tpm', 'HistoricalBudget').value('_Operation'),
