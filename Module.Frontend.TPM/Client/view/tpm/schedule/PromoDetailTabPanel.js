Ext.define('App.view.tpm.schedule.PromoDetailTabPanel', {
    extend: 'App.view.core.common.CombinedDirectoryPanel',
    alias: 'widget.promodetailtabpanel',
    margin: '20 7 20 20',
    ...
    items: [{
        ...
        tpl: Ext.create('App.view.tpm.common.promoDashboardTpl').formatTpl
    }],

    getBaseModel: function (exactryModel) {
        return Ext.ModelManager.getModel('App.model.tpm.promo.Promo');
    }
});