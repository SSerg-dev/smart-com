Ext.define('App.view.tpm.competitor.HistoricalCompetitor', {
    extend: 'App.view.core.common.CombinedDirectoryPanel',
    alias: 'widget.historicalcompetitor',
    ...
    items: [{
        ...
        store: {
            type: 'directorystore',
            model: 'App.model.tpm.competitor.HistoricalCompetitor',
            storeId: 'historicalcompetitorstore',
            extendedFilter: {
        ...
        columns: {
            ...
            items: [{
                text: l10n.ns('tpm', 'HistoricalCompetitor').value('_User'),
                dataIndex: '_User',
                filter: {
                    type: 'string',
                    operator: 'eq'
                ...
                text: l10n.ns('tpm', 'HistoricalCompetitor').value('_Role'),
                dataIndex: '_Role',
                filter: {
                    type: 'string',
                    operator: 'eq'
                ...
                text: l10n.ns('tpm', 'HistoricalCompetitor').value('_EditDate'),
                dataIndex: '_EditDate',
                xtype: 'datecolumn',
                renderer: Ext.util.Format.dateRenderer('d.m.Y H:i:s')
            }, {
                text: l10n.ns('tpm', 'HistoricalCompetitor').value('_Operation'),
