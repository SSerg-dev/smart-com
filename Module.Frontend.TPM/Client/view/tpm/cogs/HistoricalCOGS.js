Ext.define('App.view.tpm.cogs.HistoricalCOGS', {
    extend: 'App.view.core.common.CombinedDirectoryPanel',
    alias: 'widget.historicalcogs',
    ...
    items: [{
        ...
        store: {
            type: 'directorystore',
            model: 'App.model.tpm.cogs.HistoricalCOGS',
        ...
        columns: {
            ...
            items: [{
                text: l10n.ns('tpm', 'HistoricalCOGS').value('_User'),
                dataIndex: '_User',
                filter: {
                    type: 'string',
                    operator: 'eq'
                ...
                text: l10n.ns('tpm', 'HistoricalCOGS').value('_Role'),
                dataIndex: '_Role',
                filter: {
                    type: 'string',
                    operator: 'eq'
                ...
                text: l10n.ns('tpm', 'HistoricalCOGS').value('_EditDate'),
                dataIndex: '_EditDate',
                xtype: 'datecolumn',
                renderer: Ext.util.Format.dateRenderer('d.m.Y H:i:s')
            }, {
                text: l10n.ns('tpm', 'HistoricalCOGS').value('_Operation'),
