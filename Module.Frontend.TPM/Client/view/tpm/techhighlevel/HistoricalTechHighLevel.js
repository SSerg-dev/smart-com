Ext.define('App.view.tpm.techhighlevel.HistoricalTechHighLevel', {
    extend: 'App.view.core.common.CombinedDirectoryPanel',
    alias: 'widget.historicaltechhighlevel',
    ...
    items: [{
        ...
        store: {
            type: 'directorystore',
            model: 'App.model.tpm.techhighlevel.HistoricalTechHighLevel',
            storeId: 'historicaltechhighlevelstore',
            extendedFilter: {
        ...
        columns: {
            ...
            items: [{
                text: l10n.ns('tpm', 'HistoricalTechHighLevel').value('_User'),
                dataIndex: '_User',
                filter: {
                    type: 'string',
                    operator: 'eq'
                ...
                text: l10n.ns('tpm', 'HistoricalTechHighLevel').value('_Role'),
                dataIndex: '_Role',
                filter: {
                    type: 'string',
                    operator: 'eq'
                ...
                text: l10n.ns('tpm', 'HistoricalTechHighLevel').value('_EditDate'),
                dataIndex: '_EditDate',
                xtype: 'datecolumn',
                renderer: Ext.util.Format.dateRenderer('d.m.Y H:i:s')
            }, {
                text: l10n.ns('tpm', 'HistoricalTechHighLevel').value('_Operation'),
