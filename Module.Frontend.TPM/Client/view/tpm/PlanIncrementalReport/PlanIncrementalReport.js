    ...
    items: [{
        ...
        columns: {
            ...
            items: [
                ...
                { xtype: 'numbercolumn', text: l10n.ns('tpm', 'PlanIncrementalReport').value('PlanProductIncrementalCaseQty'), dataIndex: 'PlanProductIncrementalCaseQty' },
        ...
        model: 'App.model.tpm.planincrementalreport.PlanIncrementalReport',
            items: [
                ...
                { xtype: 'numberfield', name: 'PlanProductIncrementalCaseQty', fieldLabel: l10n.ns('tpm', 'PlanIncrementalReport').value('PlanProductIncrementalCaseQty') },
