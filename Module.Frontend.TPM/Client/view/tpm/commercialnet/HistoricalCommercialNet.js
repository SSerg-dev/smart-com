Ext.define('App.view.tpm.commercialnet.HistoricalCommercialNet', {
    extend: 'App.view.core.common.CombinedDirectoryPanel',
    alias: 'widget.historicalcommercialnet',
    ...
    items: [{
        ...
        store: {
            type: 'directorystore',
            model: 'App.model.tpm.commercialnet.HistoricalCommercialNet',
            storeId: 'historicalcommercialnetstore',
            extendedFilter: {
        ...
        columns: {
            ...
            items: [{
                text: l10n.ns('tpm', 'HistoricalCommercialNet').value('_User'),
                dataIndex: '_User',
                filter: {
                    type: 'string',
                    operator: 'eq'
                ...
                text: l10n.ns('tpm', 'HistoricalCommercialNet').value('_Role'),
                dataIndex: '_Role',
                filter: {
                    type: 'string',
                    operator: 'eq'
                ...
                text: l10n.ns('tpm', 'HistoricalCommercialNet').value('_EditDate'),
                dataIndex: '_EditDate',
                xtype: 'datecolumn',
                renderer: Ext.util.Format.dateRenderer('d.m.Y H:i:s')
            }, {
                text: l10n.ns('tpm', 'HistoricalCommercialNet').value('_Operation'),
