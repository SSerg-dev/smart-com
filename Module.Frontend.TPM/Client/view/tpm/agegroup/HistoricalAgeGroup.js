Ext.define('App.view.tpm.agegroup.HistoricalAgeGroup', {
    extend: 'App.view.core.common.CombinedDirectoryPanel',
    alias: 'widget.historicalagegroup',
    ...
    items: [{
        ...
        store: {
            type: 'directorystore',
            model: 'App.model.tpm.agegroup.HistoricalAgeGroup',
            storeId: 'historicalagegroupstore',
            extendedFilter: {
        ...
        columns: {
            ...
            items: [
                {
                    text: l10n.ns('tpm', 'HistoricalAgeGroup').value('_User'),
                    dataIndex: '_User',
                    filter: {
                        type: 'string',
                        operator: 'eq'
                    ...
                    text: l10n.ns('tpm', 'HistoricalAgeGroup').value('_Role'),
                    dataIndex: '_Role',
                    filter: {
                        type: 'string',
                        operator: 'eq'
                    ...
                    text: l10n.ns('tpm', 'HistoricalAgeGroup').value('_EditDate'),
                    dataIndex: '_EditDate',
                    xtype: 'datecolumn',
                    renderer: Ext.util.Format.dateRenderer('d.m.Y H:i:s')
                }, {
                    text: l10n.ns('tpm', 'HistoricalAgeGroup').value('_Operation'),
