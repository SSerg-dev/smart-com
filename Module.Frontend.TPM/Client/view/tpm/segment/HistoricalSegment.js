Ext.define('App.view.tpm.segment.HistoricalSegment', {
    extend: 'App.view.core.common.CombinedDirectoryPanel',
    alias: 'widget.historicalsegment',
    ...
    items: [{
        ...
        store: {
            type: 'directorystore',
            model: 'App.model.tpm.segment.HistoricalSegment',
            storeId: 'historicalsegmentstore',
            extendedFilter: {
        ...
        columns: {
            ...
            items: [{
                text: l10n.ns('tpm', 'HistoricalSegment').value('_User'),
                dataIndex: '_User',
                filter: {
                    type: 'string',
                    operator: 'eq'
                ...
                text: l10n.ns('tpm', 'HistoricalSegment').value('_Role'),
                dataIndex: '_Role',
                filter: {
                    type: 'string',
                    operator: 'eq'
                ...
                text: l10n.ns('tpm', 'HistoricalSegment').value('_EditDate'),
                dataIndex: '_EditDate',
                xtype: 'datecolumn',
                renderer: Ext.util.Format.dateRenderer('d.m.Y H:i:s')
            }, {
                text: l10n.ns('tpm', 'HistoricalSegment').value('_Operation'),
