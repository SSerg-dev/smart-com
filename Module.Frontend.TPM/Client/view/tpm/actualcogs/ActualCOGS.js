Ext.define('App.view.tpm.actualcogs.ActualCOGS', {
    extend: 'App.view.core.common.CombinedDirectoryPanel',
    alias: 'widget.actualcogs',
    title: l10n.ns('tpm', 'compositePanelTitles').value('ActualCOGS'),
    ...
    dockedItems: [{
        ...
        items: [{
            ...
            text: l10n.ns('tpm', 'ActualCOGS').value('recalculatePreviousYearButtonYearText'),
            tooltip: l10n.ns('tpm', 'ActualCOGS').value('recalculatePreviousYearButtonYearText'),
            disabled: true
        }, '-', '->', '-', {
    ...
    items: [{
        ...
        store: {
            type: 'directorystore',
            model: 'App.model.tpm.actualcogs.ActualCOGS',
        ...
        columns: {
            ...
            items: [{
                ...
                text: l10n.ns('tpm', 'ActualCOGS').value('Year'),
                dataIndex: 'Year'
            }, {
