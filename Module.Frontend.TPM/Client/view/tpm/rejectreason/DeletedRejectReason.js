Ext.define('App.view.tpm.rejectreason.DeletedRejectReason', {
    extend: 'App.view.core.common.CombinedDirectoryPanel',
    alias: 'widget.deletedrejectreason',
    ...
    items: [{
        ...
        store: {
            type: 'directorystore',
            model: 'App.model.tpm.rejectreason.DeletedRejectReason',
            storeId: 'deletedrejectreasonstore',
            extendedFilter: {
