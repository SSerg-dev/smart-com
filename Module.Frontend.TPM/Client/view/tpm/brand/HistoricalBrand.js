Ext.define('App.view.tpm.brand.HistoricalBrand', {
    extend: 'App.view.core.common.CombinedDirectoryPanel',
    alias: 'widget.historicalbrand',
    ...
    items: [{
        ...
        store: {
            type: 'directorystore',
            model: 'App.model.tpm.brand.HistoricalBrand',
            storeId: 'historicalbrandstore',
            extendedFilter: {
        ...
        columns: {
            ...
            items: [
            {
                text: l10n.ns('tpm', 'HistoricalBrand').value('_User'),
                dataIndex: '_User',
                filter: {
                    type: 'string',
                    operator: 'eq'
                ...
                text: l10n.ns('tpm', 'HistoricalBrand').value('_Role'),
                dataIndex: '_Role',
                filter: {
                    type: 'string',
                    operator: 'eq'
                ...
                text: l10n.ns('tpm', 'HistoricalBrand').value('_EditDate'),
                dataIndex: '_EditDate',
                xtype: 'datecolumn',
                renderer: Ext.util.Format.dateRenderer('d.m.Y H:i:s')
            }, {
                text: l10n.ns('tpm', 'HistoricalBrand').value('_Operation'),
