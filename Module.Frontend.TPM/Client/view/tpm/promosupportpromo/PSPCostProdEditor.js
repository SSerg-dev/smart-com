Ext.define('App.view.tpm.promosupportpromo.PSPCostProdEditor', {
    extend: 'App.view.core.common.EditorDetailWindow',
    alias: 'widget.pspcostprodeditor',
    width: 450,
    minWidth: 450,
    maxHeight: 600,
    ...
    items: {
        ...
        items: [{
            ...
            fieldLabel: l10n.ns('tpm', 'PromoSupportPromo').value('PlanCostProd'),
        }, {
            xtype: 'numberfield',
            name: 'FactCostProd',
            allowDecimals: true,
            ...
            fieldLabel: l10n.ns('tpm', 'PromoSupportPromo').value('ActualCostProd'),
        }]
    },
