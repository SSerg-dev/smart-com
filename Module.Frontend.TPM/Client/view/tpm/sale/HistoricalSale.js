Ext.define('App.view.tpm.sale.HistoricalSale', {
    extend: 'App.view.core.common.CombinedDirectoryPanel',
    alias: 'widget.historicalsale',
    ...
    items: [{
        ...
        store: {
            type: 'directorystore',
            model: 'App.model.tpm.sale.HistoricalSale',
            storeId: 'historicalsalestore',
            extendedFilter: {
        ...
        columns: {
            ...
            items: [
            {
                text: l10n.ns('tpm', 'HistoricalSale').value('_User'),
                dataIndex: '_User',
                filter: {
                    type: 'string',
                    operator: 'eq'
                ...
                text: l10n.ns('tpm', 'HistoricalSale').value('_Role'),
                dataIndex: '_Role',
                filter: {
                    type: 'string',
                    operator: 'eq'
                ...
                text: l10n.ns('tpm', 'HistoricalSale').value('_EditDate'),
                dataIndex: '_EditDate',
                xtype: 'datecolumn',
                renderer: Ext.util.Format.dateRenderer('d.m.Y H:i:s')
            }, {
                text: l10n.ns('tpm', 'HistoricalSale').value('_Operation'),
