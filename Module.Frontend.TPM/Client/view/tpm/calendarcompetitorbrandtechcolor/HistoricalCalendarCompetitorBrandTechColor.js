Ext.define('App.view.tpm.calendarcompetitorbrandtechcolor.HistoricalCalendarCompetitorBrandTechColor', {
    extend: 'App.view.core.common.CombinedDirectoryPanel',
    alias: 'widget.historicalcalendarcompetitorbrandtechcolor',
    ...
    items: [{
        ...
        store: {
            type: 'directorystore',
            model: 'App.model.tpm.calendarcompetitorbrandtechcolor.HistoricalCalendarCompetitorBrandTechColor',
            storeId: 'historicalcalendarcompetitorbrandtechcolorstore',
            extendedFilter: {
        ...
        columns: {
            ...
            items: [
                {
                    text: l10n.ns('tpm', 'HistoricalCalendarCompetitorBrandTechColor').value('_User'),
                    dataIndex: '_User',
                    filter: {
                        type: 'string',
                        operator: 'eq'
                    ...
                    text: l10n.ns('tpm', 'HistoricalCalendarCompetitorBrandTechColor').value('_Role'),
                    dataIndex: '_Role',
                    filter: {
                        type: 'string',
                        operator: 'eq'
                    ...
                    text: l10n.ns('tpm', 'HistoricalCalendarCompetitorBrandTechColor').value('_EditDate'),
                    dataIndex: '_EditDate',
                    xtype: 'datecolumn',
                    renderer: Ext.util.Format.dateRenderer('d.m.Y H:i:s')
                }, {
                    text: l10n.ns('tpm', 'HistoricalCalendarCompetitorBrandTechColor').value('_Operation'),
