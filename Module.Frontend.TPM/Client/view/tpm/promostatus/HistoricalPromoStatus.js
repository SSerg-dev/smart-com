Ext.define('App.view.tpm.promostatus.HistoricalPromoStatus', {
    extend: 'App.view.core.common.CombinedDirectoryPanel',
    alias: 'widget.historicalpromostatus',
    ...
    items: [{
        ...
        store: {
            type: 'directorystore',
            model: 'App.model.tpm.promostatus.HistoricalPromoStatus',
            storeId: 'historicalpromostatusstore',
            extendedFilter: {
        ...
        columns: {
            ...
            items: [
            {
                text: l10n.ns('tpm', 'HistoricalPromoStatus').value('_User'),
                dataIndex: '_User',
                filter: {
                    type: 'string',
                    operator: 'eq'
                ...
                text: l10n.ns('tpm', 'HistoricalPromoStatus').value('_Role'),
                dataIndex: '_Role',
                filter: {
                    type: 'string',
                    operator: 'eq'
                ...
                text: l10n.ns('tpm', 'HistoricalPromoStatus').value('_EditDate'),
                dataIndex: '_EditDate',
                xtype: 'datecolumn',
                renderer: Ext.util.Format.dateRenderer('d.m.Y H:i:s')
            }, {
                text: l10n.ns('tpm', 'HistoricalPromoStatus').value('_Operation'),
