Ext.define('App.view.tpm.category.HistoricalCategory', {
    extend: 'App.view.core.common.CombinedDirectoryPanel',
    alias: 'widget.historicalcategory',
    ...
    items: [{
        ...
        store: {
            type: 'directorystore',
            model: 'App.model.tpm.category.HistoricalCategory',
            storeId: 'historicalcategorystore',
            extendedFilter: {
        ...
        columns: {
            ...
            items: [{
                text: l10n.ns('tpm', 'HistoricalCategory').value('_User'),
                dataIndex: '_User',
                filter: {
                    type: 'string',
                    operator: 'eq'
                ...
                text: l10n.ns('tpm', 'HistoricalCategory').value('_Role'),
                dataIndex: '_Role',
                filter: {
                    type: 'string',
                    operator: 'eq'
                ...
                text: l10n.ns('tpm', 'HistoricalCategory').value('_EditDate'),
                dataIndex: '_EditDate',
                xtype: 'datecolumn',
                renderer: Ext.util.Format.dateRenderer('d.m.Y H:i:s')
            }, {
                text: l10n.ns('tpm', 'HistoricalCategory').value('_Operation'),
