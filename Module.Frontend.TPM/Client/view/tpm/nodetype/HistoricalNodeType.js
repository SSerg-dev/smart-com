Ext.define('App.view.tpm.nodetype.HistoricalNodeType', {
    extend: 'App.view.core.common.CombinedDirectoryPanel',
    alias: 'widget.historicalnodetype',
    ...
    items: [{
        ...
        store: {
            type: 'directorystore',
            model: 'App.model.tpm.nodeType.HistoricalNodeType',
            storeId: 'historicalnodetypestore',
            extendedFilter: {
