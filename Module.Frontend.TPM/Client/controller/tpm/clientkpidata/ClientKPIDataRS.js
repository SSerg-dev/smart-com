Ext.define('App.controller.tpm.clientkpidata.ClientKPIDataRS', {
    ...
    init: function () {
        this.listen({
            component: {
                'clientkpidatars[isSearch!=true] customlockedgrid': {
                    load: this.onGridStoreLoad,
                    itemdblclick: this.onDetailButtonClick
                },
                'clientkpidatars customlockedgrid': {
                    selectionchange: this.onGridSelectionChange,
                    afterrender: this.onGridAfterrender,
                    extfilterchange: this.onExtFilterChange
                },
                'clientkpidatars #datatable': {
                    activate: this.onActivateCard
                },
                'clientkpidatars #detailform': {
                    activate: this.onActivateCard
                },
                'clientkpidatars #detail': {
                    click: this.onDetailButtonClick
                },
                'clientkpidatars #table': {
                    click: this.onTableButtonClick
                },
                'clientkpidatars #extfilterbutton': {
                    click: this.onFilterButtonClick
                },
                'clientkpidatars #updatebutton': {
                    click: this.onUpdateButtonClick
                },
                'clientkpidatars #historybutton': {
                    click: this.onHistoryButtonClick
                },
                'clientkpidatars #refresh': {
                    click: this.onRefreshButtonClick
                },
                'clientkpidatars #close': {
                    click: this.onCloseButtonClick
                },
                // import/export
                'clientkpidatars #customexportrsbutton': {
                    click: this.onCustomExportButtonClick
                },
                'clientkpidatars #customloadimportbutton': {
                    click: this.onCustomLoadImportButtonClick
                },
                'clientkpidatars #customloadimporttemplatebutton': {
                    click: this.onCustomLoadImportTemplateButtonClick
                },
                'clientkpidatars #applyimportbutton': {
                    click: this.onApplyImportButtonClick
                },

                'clientkpidatars #gridsettings': {
                    click: this.onGridSettingsBtnClick
                },

                'clientkpidatarseditor #edit': {
    ...
    setReadOnlyFields: function () {
        var window = Ext.ComponentQuery.query('clientkpidatarseditor')[0];
