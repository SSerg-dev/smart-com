Ext.define('App.controller.tpm.promoproductpriceincreasesview.PromoProductPriceIncreasesView', {
    ...
    init: function () {
        this.listen({
            component: {
                ...
                'promoproductpriceincreasesview[isMain=true][isSearch!=true] directorygrid': {
                    load: this.onGridStoreLoad,
                },
                'promoproductpriceincreasesview[isSearch!=true] directorygrid': {
                    itemdblclick: this.onDetailButtonClick,
                },
                'promoproductpriceincreasesview directorygrid': {
                    selectionchange: this.onGridSelectionChange,
                    afterrender: this.onGridAfterrender,
                    extfilterchange: this.onExtFilterChange
                },
                'promoproductpriceincreasesview #datatable': {
                    activate: this.onActivateCard
                },
                'promoproductpriceincreasesview #detailform': {
                    activate: this.onActivateCard
                },
                'promoproductpriceincreasesview #detailform #prev': {
                    click: this.onPrevButtonClick
                },
                'promoproductpriceincreasesview #detailform #next': {
                    click: this.onNextButtonClick
                },
                'promoproductpriceincreasesview #detail': {
                    click: this.onDetailButtonClick
                },
                'promoproductpriceincreasesview #table': {
                    click: this.onTableButtonClick
                },
                'promoproductpriceincreasesview #extfilterbutton': {
                    click: this.onFilterButtonClick
                },
                'promoproductpriceincreasesview #deletedbutton': {
                    click: this.onDeletedButtonClick
                },
                'promoproductpriceincreasesview #createbutton': {
                    click: this.onCreateButtonClick
                },
                'promoproductpriceincreasesview #updatebutton': {
                    click: this.onUpdateButtonClick
                },
                'promoproductpriceincreasesview #deletebutton': {
                    click: this.onDeleteButtonClick
                },
                'promoproductpriceincreasesview #historybutton': {
                    click: this.onHistoryButtonClick
                },
                'promoproductpriceincreasesview #refresh': {
                    click: this.onRefreshButtonClick
                },
                'promoproductpriceincreasesview #close': {
                    click: this.onCloseButtonClick
                },
                //// import/export
                'promoproductpriceincreasesview #customexportxlsxbutton': {
                    click: this.onExportButtonClick
                },
                'promoproductpriceincreasesview #customloadimporttemplatexlsxbutton': {
                    click: this.onDownloadTemplateXLSX
                },
                'promoproductpriceincreasesview component[itemgroup=customloadimportbutton]': {
                    click: this.onShowImportFormButtonClick
                },
                'promoproductpriceincreasesview #loadimporttemplatebutton': {
                    click: this.onLoadImportTemplateButtonClick
                },
                'promoproductpriceincreasesview #applyimportbutton': {
