...
namespace Module.Frontend.TPM.Controllers {
    ...
    public class DeletedCompetitorBrandTechsController : EFContextController {
        private readonly IAuthorizationManager authorizationManager;

        public DeletedCompetitorBrandTechsController(IAuthorizationManager authorizationManager) {
        ...
        protected IQueryable<CompetitorBrandTech> GetConstraintedQuery() {
            ...
            IQueryable<CompetitorBrandTech> query = Context.Set<CompetitorBrandTech>();
        ...
        public IQueryable<CompetitorBrandTech> GetDeletedCompetitorBrandTechs() {
            return GetConstraintedQuery().Where(e => e.Disabled);
        }

        [ClaimsAuthorize]
        [EnableQuery(MaxNodeCount = int.MaxValue)]
        public SingleResult<CompetitorBrandTech> GetDeletedCompetitorBrandTech([FromODataUri] System.Guid key) {
