...
namespace Module.Frontend.TPM.Controllers
{
    ...
    public class TradeInvestmentsController : EFContextController
    {
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> Put([FromODataUri] System.Guid key, Delta<TradeInvestment> patch)
        {
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> Post(TradeInvestment model)
        {
            ...
            var configuration = new MapperConfiguration(cfg =>
                cfg.CreateMap<TradeInvestment, TradeInvestment>().ReverseMap());
        ...
        public async Task<IHttpActionResult> Patch([FromODataUri] System.Guid key, Delta<TradeInvestment> patch)
        {
            try
            {
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> ExportXLSX(ODataQueryOptions<TradeInvestment> options)
        {
            ...
            HandlerDataHelper.SaveIncomingArgument("TModel", typeof(TradeInvestment), data, visible: false, throwIfNotExists: false);
            HandlerDataHelper.SaveIncomingArgument("TKey", typeof(Guid), data, visible: false, throwIfNotExists: false);
            HandlerDataHelper.SaveIncomingArgument("GetColumnInstance", typeof(TradeInvestmentsController), data, visible: false, throwIfNotExists: false);
            HandlerDataHelper.SaveIncomingArgument("GetColumnMethod", nameof(TradeInvestmentsController.GetExportSettings), data, visible: false, throwIfNotExists: false);
            ...
            LoopHandler handler = new LoopHandler()
            {
                ...
                Description = $"Export {nameof(TradeInvestment)} dictionary",
