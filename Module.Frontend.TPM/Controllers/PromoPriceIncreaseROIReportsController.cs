...
{
    public class PromoPriceIncreaseROIReportsController : EFContextController
    {
        private readonly IAuthorizationManager authorizationManager;

        public PromoPriceIncreaseROIReportsController(IAuthorizationManager authorizationManager)
        {
            this.authorizationManager = authorizationManager;
        }

        protected IQueryable<PromoPriceIncreaseROIReport> GetConstraintedQuery(TPMmode tPMmode = TPMmode.Current)
        {
            ...
            IQueryable<PromoPriceIncreaseROIReport> query = Context.Set<PromoPriceIncreaseROIReport>();
        ...
        public SingleResult<PromoPriceIncreaseROIReport> GetPromoPriceIncreaseROIReport([FromODataUri] System.Guid key)
        {
            return SingleResult.Create(GetPromoPriceIncreaseROIReports());
        }

        [ClaimsAuthorize]
        [EnableQuery(MaxNodeCount = int.MaxValue)]
        public IQueryable<PromoPriceIncreaseROIReport> GetPromoPriceIncreaseROIReports(ODataQueryOptions<PromoPriceIncreaseROIReport> queryOptions = null, TPMmode tPMmode = TPMmode.Current)
        {
            IQueryable<PromoPriceIncreaseROIReport> query = GetConstraintedQuery(tPMmode);
            return query;
        }

        [ClaimsAuthorize]
        [HttpPost]
        public IQueryable<PromoPriceIncreaseROIReport> GetFilteredData(ODataQueryOptions<PromoPriceIncreaseROIReport> options)
        {
            ...
            var optionsPost = new ODataQueryOptionsPost<PromoPriceIncreaseROIReport>(options.Context, Request, HttpContext.Current.Request);
            return RoundingHelper.ModifyQuery(optionsPost.ApplyTo(query, querySettings) as IQueryable<PromoPriceIncreaseROIReport>);
        }

        [ClaimsAuthorize]
        public async Task<IHttpActionResult> ExportXLSX(ODataQueryOptions<PromoPriceIncreaseROIReport> options, [FromUri] TPMmode tPMmode)
        {
            string bodyText = Helper.GetRequestBody(HttpContext.Current.Request);
            var url = HttpContext.Current.Request.Url.AbsoluteUri;
            IQueryable results = options.ApplyTo(GetConstraintedQuery(tPMmode)).Cast<PromoPriceIncreaseROIReport>();
            UserInfo user = authorizationManager.GetCurrentUser();
            ...
            HandlerDataHelper.SaveIncomingArgument("TModel", typeof(PromoPriceIncreaseROIReport), data, visible: false, throwIfNotExists: false);
            HandlerDataHelper.SaveIncomingArgument("TKey", typeof(Guid), data, visible: false, throwIfNotExists: false);
            HandlerDataHelper.SaveIncomingArgument("GetColumnInstance", typeof(PromoPriceIncreaseROIReportsController), data, visible: false, throwIfNotExists: false);
            if (tPMmode == TPMmode.Current)
            {
                HandlerDataHelper.SaveIncomingArgument("GetColumnMethod", nameof(PromoPriceIncreaseROIReportsController.GetPromoROIExportSettingsStatic), data, visible: false, throwIfNotExists: false);
            }
            if (tPMmode == TPMmode.RS || tPMmode == TPMmode.RA)
            {
                HandlerDataHelper.SaveIncomingArgument("GetColumnMethod", nameof(PromoPriceIncreaseROIReportsController.GetPromoROIExportSettingsStaticRS), data, visible: false, throwIfNotExists: false);
            }
            ...
            LoopHandler handler = new LoopHandler()
            {
                ...
                Description = $"Export {nameof(PromoPriceIncreaseROIReport)} dictionary",
        ...
        public static string ExportXLSXYearStatic(DatabaseContext databaseContext, User user, int year, Role defaultRole, TPMmode tPMmode = TPMmode.Current, bool yearInName = false)
        {
            try
            {
                ...
                var results = databaseContext.Set<PromoPriceIncreaseROIReport>().Where(x => x.PromoStatusName != "Cancelled" && x.StartDate != null && x.StartDate.Value.Year == year);
                ...
                string filePath = exporter.GetExportFileName($"{nameof(PromoPriceIncreaseROIReport)}", userName);
                if (yearInName)
                {
        ...
        public static IEnumerable<Column> GetPromoROIExportSettingsStatic()
        {
            ...
            var columns = new List<Column>()
            {
                ...
                new Column { Order = orderNumber++, Field = "IsPriceIncrease", Header = "PriceIncrease", Quoting = false },
                ...
                new Column { Order = orderNumber++, Field = "PlanPromoVolume", Header = "Plan Promo Volume", Quoting = false,  Format = "0.00"  },
                new Column { Order = orderNumber++, Field = "PlanPromoBaselineVolume", Header = "Plan Promo Baseline Volume", Quoting = false, Format = "0.00" },
                new Column { Order = orderNumber++, Field = "PlanPromoIncrementalVolume", Header = "Plan Promo Incremental Volume", Quoting = false, Format = "0.00" },
                new Column { Order = orderNumber++, Field = "PlanPromoNetIncrementalVolume", Header = "Plan Promo Net Incremental Volume", Quoting = false, Format = "0.00" },
                new Column { Order = orderNumber++, Field = "PlanPromoPostPromoEffectVolume", Header = "Plan Promo Post Promo Effect Volume", Quoting = false, Format = "0.00" },
                new Column { Order = orderNumber++, Field = "PlanPromoPostPromoEffectVolumeW1", Header = "Plan Promo Post Promo Effect Volume W1", Quoting = false, Format = "0.00" },
                new Column { Order = orderNumber++, Field = "PlanPromoPostPromoEffectVolumeW2", Header = "Plan Promo Post Promo Effect Volume W2", Quoting = false, Format = "0.00" },
                ...
                new Column { Order = orderNumber++, Field = "PlanPromoIncrementalCOGS", Header = "Plan Promo Incremental COGS LSV", Quoting = false,  Format = "0.00"  },
                new Column { Order = orderNumber++, Field = "PlanPromoNetIncrementalCOGS", Header = "Plan Promo Net Incremental COGS LSV", Quoting = false,  Format = "0.00"  },
                new Column { Order = orderNumber++, Field = "PlanPromoIncrementalCOGSTn", Header = "Plan Promo Incremental COGS/tn", Quoting = false,  Format = "0.00"  },
                new Column { Order = orderNumber++, Field = "PlanPromoNetIncrementalCOGSTn", Header = "Plan Promo Net Incremental COGS/tn", Quoting = false,  Format = "0.00"  },
                ...
                new Column { Order = orderNumber++, Field = "PlanPromoROIPercentLSV", Header = "Plan Promo ROI % LSV", Quoting = false,  Format = "0.00"  },
                new Column { Order = orderNumber++, Field = "PlanPromoNetROIPercentLSV", Header = "Plan Promo Net ROI % LSV", Quoting = false,  Format = "0.00"  },
                new Column { Order = orderNumber++, Field = "ActualPromoROIPercentLSV", Header = "Actual Promo ROI % LSV", Quoting = false,  Format = "0.00"  },
                new Column { Order = orderNumber++, Field = "ActualPromoNetROIPercentLSV", Header = "Actual Promo Net ROI % LSV", Quoting = false,  Format = "0.00"  },
                ...
                new Column { Order = orderNumber++, Field = "PlanPromoNSVtn", Header = "Plan Promo NSV/Tn", Quoting = false,  Format = "0.00"  },
                ...
                new Column { Order = orderNumber++, Field = "PlanPromoIncrementalMACLSV", Header = "Plan Promo Incremental MAC LSV", Quoting = false,  Format = "0.00"  },
                ...
                new Column { Order = orderNumber++, Field = "PlanPromoNetIncrementalMACLSV", Header = "Plan Promo Net Incremental MAC LSV", Quoting = false,  Format = "0.00"  },
                ...
                new Column { Order = orderNumber++, Field = "ActualPromoVolume", Header = "Actual Promo Volume", Quoting = false,  Format = "0.00"  },
                new Column { Order = orderNumber++, Field = "ActualPromoBaselineVolume", Header = "Actual Promo Baseline Volume", Quoting = false,  Format = "0.00"  },
                new Column { Order = orderNumber++, Field = "ActualPromoIncrementalVolume", Header = "Actual Promo Incremental Volume", Quoting = false,  Format = "0.00"  },
                new Column { Order = orderNumber++, Field = "ActualPromoNetIncrementalVolume", Header = "Actual Promo Net Incremental Volume", Quoting = false,  Format = "0.00"  },
                new Column { Order = orderNumber++, Field = "ActualPromoPostPromoEffectVolume", Header = "Actual Promo Post Promo Effect Volume", Quoting = false,  Format = "0.00"  },
                new Column { Order = orderNumber++, Field = "ActualPromoVolumeByCompensation", Header = "Actual Promo Volume By Compensation", Quoting = false,  Format = "0.00"  },
                new Column { Order = orderNumber++, Field = "ActualPromoVolumeSI", Header = "Actual Promo Volume SI", Quoting = false,  Format = "0.00"  },
                ...
                new Column { Order = orderNumber++, Field = "ActualPromoLSVSI", Header = "Actual Promo LSV SI", Quoting = false,  Format = "0.00"  },
                new Column { Order = orderNumber++, Field = "ActualPromoLSVSO", Header = "Actual Promo LSV SO", Quoting = false,  Format = "0.00"  },
                ...
                new Column { Order = orderNumber++, Field = "ActualPromoIncrementalCOGS", Header = "Actual Promo Incremental COGS LSV", Quoting = false,  Format = "0.00"  },
                new Column { Order = orderNumber++, Field = "ActualPromoNetIncrementalCOGS", Header = "Actual Promo Net Incremental COGS LSV", Quoting = false,  Format = "0.00"  },
                new Column { Order = orderNumber++, Field = "ActualPromoIncrementalCOGSTn", Header = "Actual Promo Incremental COGS/tn", Quoting = false,  Format = "0.00"  },
                new Column { Order = orderNumber++, Field = "ActualPromoNetIncrementalCOGSTn", Header = "Actual Promo Net Incremental COGS/tn", Quoting = false,  Format = "0.00"  },
                ...
                new Column { Order = orderNumber++, Field = "ActualPromoNSVtn", Header = "Actual Promo NSV/Tn", Quoting = false,  Format = "0.00"  },
                ...
                new Column { Order = orderNumber++, Field = "ActualPromoIncrementalMACLSV", Header = "Actual Promo Incremental MAC LSV", Quoting = false,  Format = "0.00"  },
                ...
                new Column { Order = orderNumber++, Field = "ActualPromoNetIncrementalMACLSV", Header = "Actual Promo Net Incremental MAC LSV", Quoting = false,  Format = "0.00"  },
                ...
                new Column { Order = orderNumber++, Field = "IsPriceIncrease", Header = "Price Increase", Quoting = false,  Format = "0.00"  },
                new Column { Order = orderNumber++, Field = "IsApolloExport", Header = "Anaplan Export", Quoting = false,  Format = "0.00"  },
                new Column { Order = orderNumber++, Field = "MLmodel", Header = "ML model", Quoting = false },
            };
            return columns;
        }
        public static IEnumerable<Column> GetPromoROIExportSettingsStaticRS()
        {
            int orderNumber = 1;
            var columns = new List<Column>()
            {
