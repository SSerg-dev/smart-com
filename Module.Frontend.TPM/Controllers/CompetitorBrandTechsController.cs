...
namespace Module.Frontend.TPM.Controllers
{
    public class CompetitorBrandTechsController : EFContextController
    {
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> Put([FromODataUri] System.Guid key, Delta<CompetitorBrandTech> patch)
        {
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> Post(CompetitorBrandTech model)
        {
        ...
        public async Task<IHttpActionResult> Patch([FromODataUri] System.Guid key, Delta<CompetitorBrandTech> patch)
        {
            try
            {
                var model = Context.Set<CompetitorBrandTech>().Find(key);
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> ExportXLSX(ODataQueryOptions<CompetitorBrandTech> options)
        {
        ...
        public async Task<HttpResponseMessage> FullImportXLSX()
        {
            try
            {
                ...
                await CreateImportTask(fileName, "FullXLSXCompetitorBrandTechUpdateImportHandler", form);
