...
namespace Module.Frontend.TPM.Controllers {
    ...
    public class DeletedRATIShoppersController : EFContextController {
        private readonly IAuthorizationManager authorizationManager;

        public DeletedRATIShoppersController(IAuthorizationManager authorizationManager) {
        ...
        public IQueryable<RATIShopper> GetDeletedRATIShoppers() {
            return GetConstraintedQuery().Where(e => e.Disabled);
        }

        [ClaimsAuthorize]
        [EnableQuery(MaxNodeCount = int.MaxValue)]
        public SingleResult<RATIShopper> GetDeletedRATIShopper([FromODataUri] System.Guid key) {
