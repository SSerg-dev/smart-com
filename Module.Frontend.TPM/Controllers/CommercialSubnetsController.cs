...
namespace Module.Frontend.TPM.Controllers
{
    ...
    public class CommercialSubnetsController : EFContextController
    {
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> Put([FromODataUri] System.Guid key, Delta<CommercialSubnet> patch)
        {
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> Post(CommercialSubnet model)
        {
        ...
        public async Task<IHttpActionResult> Patch([FromODataUri] System.Guid key, Delta<CommercialSubnet> patch)
        {
            try
            {
                var model = Context.Set<CommercialSubnet>().Find(key);
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> ExportXLSX(ODataQueryOptions<CommercialSubnet> options)
        {
            ...
            HandlerDataHelper.SaveIncomingArgument("TModel", typeof(CommercialSubnet), data, visible: false, throwIfNotExists: false);
            HandlerDataHelper.SaveIncomingArgument("TKey", typeof(Guid), data, visible: false, throwIfNotExists: false);
            HandlerDataHelper.SaveIncomingArgument("GetColumnInstance", typeof(CommercialSubnetsController), data, visible: false, throwIfNotExists: false);
            HandlerDataHelper.SaveIncomingArgument("GetColumnMethod", nameof(CommercialSubnetsController.GetExportSettings), data, visible: false, throwIfNotExists: false);
            ...
            LoopHandler handler = new LoopHandler()
            {
                ...
                Description = $"Export {nameof(CommercialSubnet)} dictionary",
