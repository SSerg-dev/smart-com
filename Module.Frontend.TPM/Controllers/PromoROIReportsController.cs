    ...
    public class PromoROIReportsController : EFContextController
    {
        ...
        public static IEnumerable<Column> GetPromoROIExportSettingsStatic()
        {
            ...
            var columns = new List<Column>()
            {
                ...
                new Column { Order = orderNumber++, Field = "PlanPromoIncrementalErnings", Header = "Plan Promo Incremental Earnings", Quoting = false,  Format = "0.00"  },
                new Column { Order = orderNumber++, Field = "PlanPromoNetIncrementalErningsLSV", Header = "Plan Promo Net Incremental Earnings LSV", Quoting = false,  Format = "0.00"  },
                new Column { Order = orderNumber++, Field = "ActualPromoIncrementalErningsLSV", Header = "Actual Promo Incremental  Earnings LSV", Quoting = false,  Format = "0.00"  },
                new Column { Order = orderNumber++, Field = "ActualPromoNetIncrementalErningsLSV", Header = "Actual Promo Net Incremental  Earnings LSV", Quoting = false,  Format = "0.00"  },
                ...
                new Column { Order = orderNumber++, Field = "PlanPromoIncrementalMACLCV", Header = "Plan Promo Incremental MAC LCV", Quoting = false,  Format = "0.00"  },
