...
namespace Module.Frontend.TPM.Controllers
{
    public class PlanPostPromoEffectsController : EFContextController
    {
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> Put([FromODataUri] System.Guid key, Delta<PlanPostPromoEffect> patch)
        {
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> Post(PlanPostPromoEffect model)
        {
        ...
        public async Task<IHttpActionResult> Patch([FromODataUri] System.Guid key, Delta<PlanPostPromoEffect> patch)
        {
            try
            {
                var model = Context.Set<PlanPostPromoEffect>().Find(key);
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> ExportXLSX(ODataQueryOptions<PlanPostPromoEffect> options)
        {
