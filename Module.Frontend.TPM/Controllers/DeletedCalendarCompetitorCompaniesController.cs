...
namespace Module.Frontend.TPM.Controllers {
    ...
    public class DeletedCalendarCompetitorCompaniesController : EFContextController {
        private readonly IAuthorizationManager authorizationManager;

        public DeletedCalendarCompetitorCompaniesController(IAuthorizationManager authorizationManager) {
        ...
        protected IQueryable<CalendarCompetitorCompany> GetConstraintedQuery() {
            ...
            IQueryable<CalendarCompetitorCompany> query = Context.Set<CalendarCompetitorCompany>();
        ...
        public IQueryable<CalendarCompetitorCompany> GetDeletedTechnologies() {
            return GetConstraintedQuery().Where(e => e.Disabled);
        }

        [ClaimsAuthorize]
        [EnableQuery(MaxNodeCount = int.MaxValue)]
        public SingleResult<CalendarCompetitorCompany> GetDeletedTechnology([FromODataUri] System.Guid key) {
