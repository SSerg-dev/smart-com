...
namespace Module.Frontend.TPM.Controllers {
    ...
    public class DeletedClientsController : EFContextController {
        private readonly IAuthorizationManager authorizationManager;

        public DeletedClientsController(IAuthorizationManager authorizationManager) {
        ...
        public IQueryable<Client> GetDeletedClients() {
            return GetConstraintedQuery().Where(e => e.Disabled);
        }

        [ClaimsAuthorize]
        [EnableQuery(MaxNodeCount = int.MaxValue, MaxExpansionDepth = 3)]
        public SingleResult<Client> GetDeletedClient([FromODataUri] System.Guid key) {
