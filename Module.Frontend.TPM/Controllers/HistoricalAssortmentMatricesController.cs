...
namespace Module.Frontend.TPM.Controllers {
    ...
    public class HistoricalAssortmentMatricesController : ODataController {
        [Inject]
        ...
        [EnableQuery(
            ...
            MaxTop = 1024)]
        public IQueryable<HistoricalAssortmentMatrix> GetHistoricalAssortmentMatrices() {
            return HistoryReader.GetAll<HistoricalAssortmentMatrix>();
        }
        ...
        [EnableQuery(
            ...
            EnableConstantParameterization = false,
            MaxTop = 1024)]
        public IQueryable<HistoricalAssortmentMatrix> GetHistoricalAssortmentMatrices(Guid? Id)
        {
            return HistoryReader.GetAllById<HistoricalAssortmentMatrix>(Id.ToString());
        }

        [ClaimsAuthorize]
        [HttpPost]
        public IQueryable<HistoricalAssortmentMatrix> GetFilteredData(ODataQueryOptions<HistoricalAssortmentMatrix> options)
        {
