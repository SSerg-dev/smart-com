...
namespace Module.Frontend.TPM.Controllers
{
    ...
    public class SalesController : EFContextController
    {
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> Put([FromODataUri] System.Guid key, Delta<Sale> patch)
        {
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> Post(Sale model)
        {
            ...
            var configuration = new MapperConfiguration(cfg =>
                cfg.CreateMap<Sale, Sale>().ReverseMap());
        ...
        public async Task<IHttpActionResult> Patch([FromODataUri] System.Guid key, Delta<Sale> patch)
        {
            try
            {
                var model = Context.Set<Sale>().Find(key);
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> ExportXLSX(ODataQueryOptions<Sale> options)
        {
