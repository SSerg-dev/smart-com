...
namespace Module.Frontend.TPM.Controllers {
    ...
    public class DeletedCompetitorsController : EFContextController {
        private readonly IAuthorizationManager authorizationManager;

        public DeletedCompetitorsController(IAuthorizationManager authorizationManager) {
        ...
        protected IQueryable<Competitor> GetConstraintedQuery() {
            ...
            IQueryable<Competitor> query = Context.Set<Competitor>();
        ...
        public IQueryable<Competitor> GetDeletedCompetitors() {
            return GetConstraintedQuery().Where(e => e.Disabled);
        }

        [ClaimsAuthorize]
        [EnableQuery(MaxNodeCount = int.MaxValue)]
        public SingleResult<Competitor> GetDeletedCompetitor([FromODataUri] System.Guid key) {
