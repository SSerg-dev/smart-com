...
namespace Module.Frontend.TPM.Controllers {
    ...
    public class DeletedPostPromoEffectsController : EFContextController {
        private readonly IAuthorizationManager authorizationManager;

        public DeletedPostPromoEffectsController(IAuthorizationManager authorizationManager) {
        ...
        protected IQueryable<PostPromoEffect> GetConstraintedQuery() {
            ...
            IQueryable<PostPromoEffect> query = Context.Set<PostPromoEffect>();
        ...
        public IQueryable<PostPromoEffect> GetDeletedPostPromoEffects() {
            return GetConstraintedQuery().Where(e => e.Disabled);
        }

        [ClaimsAuthorize]
        [EnableQuery(MaxNodeCount = int.MaxValue)]
        public SingleResult<PostPromoEffect> GetDeletedPostPromoEffect([FromODataUri] System.Guid key) {
