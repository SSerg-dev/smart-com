...
namespace Module.Frontend.TPM.Controllers {
    ...
    public class HistoricalTechnologiesController : ODataController {
        ...
        [ClaimsAuthorize]
        [HttpPost]
        public IQueryable<HistoricalTechnology> GetFilteredData(ODataQueryOptions<HistoricalTechnology> options)
        {
            var query = Enumerable.Empty<HistoricalTechnology>().AsQueryable();
            ...
            if (isArgumentExists)
            {
                ...
                query = HistoryReader.GetAllById<HistoricalTechnology>(id.ToString());
            }
            else
            {
                query = HistoryReader.GetAll<HistoricalTechnology>();
            }
            ...
            var optionsPost = new ODataQueryOptionsPost<HistoricalTechnology>(options.Context, Request, HttpContext.Current.Request);
            return optionsPost.ApplyTo(query, querySettings) as IQueryable<HistoricalTechnology>;
        }
