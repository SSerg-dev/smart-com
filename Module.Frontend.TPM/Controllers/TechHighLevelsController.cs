...
namespace Module.Frontend.TPM.Controllers
{
    ...
    public class TechHighLevelsController : EFContextController
    {
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> Put([FromODataUri] System.Guid key, Delta<TechHighLevel> patch)
        {
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> Post(TechHighLevel model)
        {
        ...
        public async Task<IHttpActionResult> Patch([FromODataUri] System.Guid key, Delta<TechHighLevel> patch)
        {
            try
            {
                var model = Context.Set<TechHighLevel>().Find(key);
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> ExportXLSX(ODataQueryOptions<TechHighLevel> options)
        {
