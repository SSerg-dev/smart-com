    ...
    public class TechHighLevelsController : EFContextController
    {
        ...
        public IHttpActionResult Post(TechHighLevel model)
        {
            ...
            var configuration = new MapperConfiguration(cfg =>
                cfg.CreateMap<TechHighLevel, TechHighLevel>().ReverseMap());
        ...
        public IHttpActionResult ExportXLSX(ODataQueryOptions<TechHighLevel> options)
        {
            ...
            using (DatabaseContext context = new DatabaseContext())
            {
                ...
                HandlerDataHelper.SaveIncomingArgument("TModel", typeof(TechHighLevel), data, visible: false, throwIfNotExists: false);
                HandlerDataHelper.SaveIncomingArgument("TKey", typeof(Guid), data, visible: false, throwIfNotExists: false);
                HandlerDataHelper.SaveIncomingArgument("GetColumnInstance", typeof(TechHighLevelsController), data, visible: false, throwIfNotExists: false);
                HandlerDataHelper.SaveIncomingArgument("GetColumnMethod", nameof(TechHighLevelsController.GetExportSettings), data, visible: false, throwIfNotExists: false);
                ...
                LoopHandler handler = new LoopHandler()
                {
                    ...
                    Description = $"Export {nameof(TechHighLevel)} dictionary",
