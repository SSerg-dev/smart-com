...
namespace Module.Frontend.TPM.Controllers
{
    public class CompetitorsController : EFContextController
    {
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> Post(Competitor model)
        {
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> Put([FromODataUri] Guid key, Delta<Competitor> patch)
        {
            return await UpdateEntity(key, patch);
        }

        [ClaimsAuthorize]
        [AcceptVerbs("PATCH", "MERGE")]
        public async Task<IHttpActionResult> Patch([FromODataUri] Guid key, Delta<Competitor> patch)
        {
            return await UpdateEntity(key, patch);
        }
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> ExportXLSX(ODataQueryOptions<Competitor> options)
        {
        ...
        public async Task<HttpResponseMessage> FullImportXLSX()
        {
            try
            {
                ...
                await CreateImportTask(fileName, "FullXLSXCompetitorUpdateImportHandler");
        ...
        private async Task<IHttpActionResult> UpdateEntity(Guid key, Delta<Competitor> patch)
        {
            var model = Context.Set<Competitor>().Find(key);
            if (model == null)
            {
