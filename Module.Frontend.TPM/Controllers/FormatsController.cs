...
namespace Module.Frontend.TPM.Controllers
{
    ...
    public class FormatsController : EFContextController
    {
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> Put([FromODataUri] System.Guid key, Delta<Format> patch)
        {
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> Post(Format model)
        {
            ...
            var configuration = new MapperConfiguration(cfg =>
                cfg.CreateMap<Format, Format>().ReverseMap());
        ...
        public async Task<IHttpActionResult> Patch([FromODataUri] System.Guid key, Delta<Format> patch)
        {
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> ExportXLSX(ODataQueryOptions<Format> options)
        {
            ...
            HandlerDataHelper.SaveIncomingArgument("TModel", typeof(Format), data, visible: false, throwIfNotExists: false);
            HandlerDataHelper.SaveIncomingArgument("TKey", typeof(Guid), data, visible: false, throwIfNotExists: false);
            HandlerDataHelper.SaveIncomingArgument("GetColumnInstance", typeof(FormatsController), data, visible: false, throwIfNotExists: false);
            HandlerDataHelper.SaveIncomingArgument("GetColumnMethod", nameof(FormatsController.GetExportSettings), data, visible: false, throwIfNotExists: false);
            ...
            LoopHandler handler = new LoopHandler()
            {
                ...
                Description = $"Export {nameof(Format)} dictionary",
