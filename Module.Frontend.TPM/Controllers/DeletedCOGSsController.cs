...
namespace Module.Frontend.TPM.Controllers {
    ...
    public class DeletedCOGSsController : EFContextController {
        private readonly IAuthorizationManager authorizationManager;

        public DeletedCOGSsController(IAuthorizationManager authorizationManager) {
        ...
        protected IQueryable<COGS> GetConstraintedQuery() {
            ...
            IQueryable<COGS> query = Context.Set<COGS>();
        ...
        public IQueryable<COGS> GetDeletedCOGSs() {
            return GetConstraintedQuery().Where(e => e.Disabled);
        }

        [ClaimsAuthorize]
        [EnableQuery(MaxNodeCount = int.MaxValue)]
        public SingleResult<COGS> GetDeletedCOGS([FromODataUri] System.Guid key) {
