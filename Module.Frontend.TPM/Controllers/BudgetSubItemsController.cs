...
namespace Module.Frontend.TPM.Controllers
{
    ...
    public class BudgetSubItemsController : EFContextController
    {
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> Put([FromODataUri] System.Guid key, Delta<BudgetSubItem> patch)
        {
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> Post(BudgetSubItem model)
        {
        ...
        public async Task<IHttpActionResult> Patch([FromODataUri] System.Guid key, Delta<BudgetSubItem> patch)
        {
            try
            {
                var model = Context.Set<BudgetSubItem>().Find(key);
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> ExportXLSX(ODataQueryOptions<BudgetSubItem> options)
        {
        ...
        public async Task<HttpResponseMessage> FullImportXLSX()
        {
            try
            {
                ...
                await CreateImportTask(fileName, "FullXLSXUpdateBudgetSubItemHandler");
