...
{
    public class DeletedActualCOGSTnsController : EFContextController
    {
        private readonly IAuthorizationManager authorizationManager;

        public DeletedActualCOGSTnsController(IAuthorizationManager authorizationManager)
        {
        ...
        protected IQueryable<ActualCOGSTn> GetConstraintedQuery()
        {
            ...
            IQueryable<ActualCOGSTn> query = Context.Set<ActualCOGSTn>();
        ...
        public IQueryable<ActualCOGSTn> GetDeletedActualCOGSTns()
        {
        ...
        [ClaimsAuthorize]
        [EnableQuery(MaxNodeCount = int.MaxValue)]
        public SingleResult<ActualCOGSTn> GetDeletedActualCOGSTn([FromODataUri] System.Guid key)
        {
