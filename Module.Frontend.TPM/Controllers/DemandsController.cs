...
namespace Module.Frontend.TPM.Controllers
{
    public class DemandsController : EFContextController
    {
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> Put([FromODataUri] System.Guid key, Delta<Demand> patch)
        {
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> Post(Demand model)
        {
            ...
            var configuration = new MapperConfiguration(cfg =>
                cfg.CreateMap<Demand, Demand>().ReverseMap());
        ...
        public async Task<IHttpActionResult> Patch([FromODataUri] System.Guid key, Delta<Demand> patch)
        {
            try
            {
                var model = Context.Set<Demand>().Find(key);
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> ExportXLSX(ODataQueryOptions<Demand> options)
        {
        ...
        public async Task<HttpResponseMessage> FullImportXLSX()
        {
            try
            {
                ...
                await CreateImportTask(fileName, "FullXLSXUpdateImportDemandHandler");
