	...
	public class PlanIncrementalReportsController : EFContextController
	{
		...
		private IEnumerable<Column> GetExportSettings()
		{
			IEnumerable<Column> columns = new List<Column>() {
				...
				new Column() { Order = 10, Field = "StartDate", Header = "Promo Start date", Quoting = false, Format = "dd.MM.yyyy"  },
				new Column() { Order = 11, Field = "EndDate", Header = "Promo End date", Quoting = false, Format = "dd.MM.yyyy" },
