...
namespace Module.Frontend.TPM.Controllers
{
    public class MechanicTypesController : EFContextController
    {
        ...
        public IHttpActionResult Post(MechanicType model)
        {
            ...
            var result = (MechanicType)Mapper.Map(model, proxy, typeof(MechanicType), proxy.GetType(), opts => opts.CreateMissingTypeMaps = true);
        ...
        public IHttpActionResult ExportXLSX(ODataQueryOptions<MechanicType> options)
        {
            try
            {
                ...
                string filePath = exporter.GetExportFileName("MechanicType", username);
