...
namespace Module.Frontend.TPM.Controllers
{
    public class MechanicTypesController : EFContextController
    {
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> Put([FromODataUri] System.Guid key, Delta<MechanicType> patch)
        {
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> Post(MechanicType model)
        {
        ...
        public async Task<IHttpActionResult> Patch([FromODataUri] System.Guid key, Delta<MechanicType> patch)
        {
            try
            {
                var model = Context.Set<MechanicType>().Find(key);
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> ExportXLSX(ODataQueryOptions<MechanicType> options)
        {
        ...
        public async Task<HttpResponseMessage> FullImportXLSX()
        {
            try
            {
                ...
                await CreateImportTask(fileName, "FullXLSXMechanicTypeUpdateImporHandler");
