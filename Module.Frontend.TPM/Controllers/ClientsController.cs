...
namespace Module.Frontend.TPM.Controllers
{
    ...
    public class ClientsController : EFContextController
    {
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> Put([FromODataUri] System.Guid key, Delta<Client> patch)
        {
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> Post(Client model)
        {
        ...
        public async Task<IHttpActionResult> Patch([FromODataUri] System.Guid key, Delta<Client> patch)
        {
            try
            {
                var model = Context.Set<Client>().Find(key);
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> ExportXLSX(ODataQueryOptions<Client> options)
        {
