...
namespace Module.Frontend.TPM.Controllers
{
    public class PlanCOGSTnsController : EFContextController
    {
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> Put([FromODataUri] Guid key, Delta<PlanCOGSTn> patch)
        {
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> Post(PlanCOGSTn model)
        {
            ...
            if (!DateCheck(result))
            {
                string msg = "There can not be two Plan COGS/Tn of client and Brand Tech  in some Time";
        ...
        public async Task<IHttpActionResult> Patch([FromODataUri] Guid key, Delta<PlanCOGSTn> patch)
        {
            try
            {
                var model = Context.Set<PlanCOGSTn>().Find(key);
        ...
        [ClaimsAuthorize]
        public async Task<IHttpActionResult> ExportXLSX(ODataQueryOptions<PlanCOGSTn> options)
        {
