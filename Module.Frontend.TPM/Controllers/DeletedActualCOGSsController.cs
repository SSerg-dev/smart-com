...
namespace Module.Frontend.TPM.Controllers {
    ...
    public class DeletedActualCOGSsController : EFContextController {
        private readonly IAuthorizationManager authorizationManager;

        public DeletedActualCOGSsController(IAuthorizationManager authorizationManager) {
        ...
        protected IQueryable<ActualCOGS> GetConstraintedQuery() {
            ...
            IQueryable<ActualCOGS> query = Context.Set<ActualCOGS>();
        ...
        public IQueryable<ActualCOGS> GetDeletedActualCOGSs() {
            return GetConstraintedQuery().Where(e => e.Disabled);
        }

        [ClaimsAuthorize]
        [EnableQuery(MaxNodeCount = int.MaxValue)]
        public SingleResult<ActualCOGS> GetDeletedActualCOGS([FromODataUri] System.Guid key) {
