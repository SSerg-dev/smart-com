...
namespace Module.Frontend.TPM.Controllers
{
    public class RejectReasonsController : EFContextController
    {
        ...
        public IHttpActionResult Post(RejectReason model)
        {
            ...
            var result = (RejectReason)Mapper.Map(model, proxy, typeof(RejectReason), proxy.GetType(), opts => opts.CreateMissingTypeMaps = true);
        ...
        public IHttpActionResult ExportXLSX(ODataQueryOptions<RejectReason> options)
        {
            try
            {
                ...
                string filePath = exporter.GetExportFileName("RejectReason", username);
