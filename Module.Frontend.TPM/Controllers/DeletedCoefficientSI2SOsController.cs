...
{
    public class DeletedCoefficientSI2SOsController : EFContextController
    {
        private readonly IAuthorizationManager authorizationManager;

        public DeletedCoefficientSI2SOsController(IAuthorizationManager authorizationManager)
        {
        ...
        protected IQueryable<CoefficientSI2SO> GetConstraintedQuery()
        {
            ...
            IQueryable<CoefficientSI2SO> query = Context.Set<CoefficientSI2SO>();
        ...
        public IQueryable<CoefficientSI2SO> GetDeletedCoefficientSI2SOs()
        {
        ...
        [ClaimsAuthorize]
        [EnableQuery(MaxNodeCount = int.MaxValue)]
        public SingleResult<CoefficientSI2SO> GetDeletedCoefficientSI2SO([FromODataUri] System.Guid key)
        {
