...
namespace Module.Frontend.TPM.Controllers {
    ...
    public class DeletedActualTradeInvestmentsController : EFContextController {
        private readonly IAuthorizationManager authorizationManager;

        public DeletedActualTradeInvestmentsController(IAuthorizationManager authorizationManager) {
        ...
        protected IQueryable<ActualTradeInvestment> GetConstraintedQuery() {
            ...
            IQueryable<ActualTradeInvestment> query = Context.Set<ActualTradeInvestment>();
        ...
        public IQueryable<ActualTradeInvestment> GetDeletedActualTradeInvestments() {
            return GetConstraintedQuery().Where(e => e.Disabled);
        }

        [ClaimsAuthorize]
        [EnableQuery(MaxNodeCount = int.MaxValue)]
        public SingleResult<ActualTradeInvestment> GetDeletedActualTradeInvestment([FromODataUri] System.Guid key) {
