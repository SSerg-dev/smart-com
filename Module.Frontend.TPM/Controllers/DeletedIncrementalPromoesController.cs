...
namespace Module.Frontend.TPM.Controllers
{
    ...
    public class DeletedIncrementalPromoesController : EFContextController
    {
        private readonly IAuthorizationManager authorizationManager;

        public DeletedIncrementalPromoesController(IAuthorizationManager authorizationManager)
        {
        ...
        protected IQueryable<IncrementalPromo> GetConstraintedQuery()
        {
            ...
            IQueryable<IncrementalPromo> query = Context.Set<IncrementalPromo>();
        ...
        public IQueryable<IncrementalPromo> GetDeletedIncrementalPromoes()
        {
        ...
        [ClaimsAuthorize]
        [EnableQuery(MaxNodeCount = int.MaxValue)]
        public SingleResult<IncrementalPromo> GetDeletedIncrementalPromo([FromODataUri] System.Guid key)
        {
