...
def generate_entity_list(parameters:dict):
    ...
    entities = [
              {'SrcPath':'https://marsanalyticsprodadls.dfs.core.windows.net/output/RUSSIA_PETCARE_DEMAND_PLANNING_DM/ANAPLAN/EXPORT/BASELINE_WO_PRICING/BASELINE_WO_PRICING_0.csv','DstPath':dst_incr_dir},
