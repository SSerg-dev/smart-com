...
def generate_entity_list(parameters:dict):
    ...
    date_folders=pendulum.now().strftime("%Y/%m/%d/%H/%M")
  	
    entities = [
	 {'SrcPath':f'{output_path}/Promo/Promo.CSV','DstPath':f'https://marsanalyticsprodadls.dfs.core.windows.net/output/RUSSIA_PETCARE_JUPITER/YANDEX/{date_folders}/Promo.CSV'},
              {'SrcPath':f'{output_path}/PromoProduct/PromoProduct.CSV','DstPath':f'https://marsanalyticsprodadls.dfs.core.windows.net/output/RUSSIA_PETCARE_JUPITER/YANDEX/{date_folders}/PromoProduct.CSV'},
              {'SrcPath':f'{output_path}/PromoSupportPromo/PromoSupportPromo.CSV','DstPath':f'https://marsanalyticsprodadls.dfs.core.windows.net/output/RUSSIA_PETCARE_JUPITER/YANDEX/{date_folders}/PromoSupportPromo.CSV'},
              {'SrcPath':f'{output_path}/ServiceInfo/ServiceInfo.CSV','DstPath':f'https://marsanalyticsprodadls.dfs.core.windows.net/output/RUSSIA_PETCARE_JUPITER/YANDEX/{date_folders}/ServiceInfo.CSV'},
              {'SrcPath':f'{output_path}/ProductChangeIncident/NewProductChangeIncident.CSV','DstPath':f'https://marsanalyticsprodadls.dfs.core.windows.net/output/RUSSIA_PETCARE_JUPITER/YANDEX/{date_folders}/NewProductChangeIncident.CSV'},
              {'SrcPath':f'{output_path}/ChangesIncident/ChangesIncident.CSV','DstPath':f'https://marsanalyticsprodadls.dfs.core.windows.net/output/RUSSIA_PETCARE_JUPITER/YANDEX/{date_folders}/ChangesIncident.CSV'},
