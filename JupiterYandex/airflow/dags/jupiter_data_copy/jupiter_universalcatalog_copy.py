...
def generate_entity_list(parameters:dict):
    ...
    entities = [
              {'SrcPath':'/FILES/UNIVERSALCATALOG/MARS_UNIVERSAL_CALENDAR.csv','DstPath':dst_dir},
              {'SrcPath':'/FILES/UNIVERSALCATALOG/MARS_UNIVERSAL_PETCARE_CUSTOMERS.csv','DstPath':dst_dir},
              {'SrcPath':'/FILES/UNIVERSALCATALOG/MARS_UNIVERSAL_PETCARE_MATERIALS.csv','DstPath':dst_dir},
              {'SrcPath':'/FILES/UNIVERSALCATALOG/MARS_UNIVERSAL_PETCARE_PRICELIST_GENERAL.csv','DstPath':dst_dir},
             ]
    return entities

with DAG(
    dag_id='jupiter_universalcatalog_copy',
