...
def generate_entity_list(parameters:dict):
    ...
    entities = [
              {'SrcPath':'/FILES/SELLIN/HELIOS_ACTUALS_BDM.parquet','DstPath':dst_dir},
              {'SrcPath':'/FILES/SELLIN/YEAR_END_ESTIMATE_BDM.parquet','DstPath':dst_dir},
             ]
    return entities

with DAG(
    dag_id='jupiter_sellin_copy',
