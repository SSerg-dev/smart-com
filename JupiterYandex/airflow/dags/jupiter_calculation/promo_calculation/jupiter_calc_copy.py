...
# Upload entities from sql to hdfs in parallel
    upload_tables = BashOperator.partial(task_id="upload_tables", do_xcom_push=True,execution_timeout=datetime.timedelta(minutes=10), retries=2,retry_delay=datetime.timedelta(minutes=1)).expand(
