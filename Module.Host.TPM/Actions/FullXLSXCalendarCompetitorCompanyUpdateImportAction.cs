...
{
    class FullXLSXCalendarCompetitorCompanyUpdateImportAction : BaseAction
    {
        ...
        public FullXLSXCalendarCompetitorCompanyUpdateImportAction(FullImportSettings settings)
        {
