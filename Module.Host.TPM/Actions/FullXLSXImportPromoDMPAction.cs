...
namespace Module.Host.TPM.Actions {
    class FullXLSXImportPromoDMPAction : BaseAction {
        ...
        private readonly Guid promoSupportId;
        ...
        public FullXLSXImportPromoDMPAction(FullImportSettings settings, int planQuantity, Guid promoSupportId) {
            ...
            this.promoSupportId = promoSupportId;
        ...
        public override void Execute() {
            ...
            try {
                ...
                //var sumQuantity = sourceRecords.Select(x => (ImportPromoDMP)x).Sum(x=>x.Quantity);
