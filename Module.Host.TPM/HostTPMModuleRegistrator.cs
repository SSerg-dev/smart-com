    ...
    public class HostTPMModuleRegistrator : IHostModuleRegistrator {
        public IEnumerable<IHandler> GetHandlers() {
            return new List<IHandler>()
            {
                ...
                new Handlers.FullXLSXCalendarCompetitorBrandTechColorUpdateImportHandler(),
                new Handlers.FullXLSXCalendarCompetitorPromoUpdateImportHandler(),
                new Handlers.FullXLSXCalendarCompetitorCompanyUpdateImportHandler(),
