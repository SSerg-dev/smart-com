    ...
    public class UpdateUpliftHandler : BaseHandler
    {
        public override void Action(HandlerInfo info, ExecuteData data)
        {
            ...
            try
            {
                ...
                handlerLogger.Write(true, String.Format("The uplift calculation started at {0:yyyy-MM-dd HH:mm:ss}", DateTimeOffset.Now));
                    ...
                    if (promoQuery.Count() != 0)
                    {
                        ...
                        if (promoSubrangeList != null && promoSubrangeList.Count() != 0)
                        {
                            ...
                            if (success)
                            {
                                ...
                                handlerLogger.Write(true, String.Format("Calculated uplift value: {0}%", countedPlanUplift));
                            }
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                if (success)
                                {
                                    ...
                                    //handlerLogger.Write(true, String.Format("Для расчета uplift найдено {0} Promo", promoQuery.Count()));
                                    handlerLogger.Write(true, String.Format("Calculated uplift value: {0}%", brandTechCountedPlanUplift));
                                }
                                else
                                {
                                    handlerLogger.Write(true, "No Promo found to calculate Uplift");
            ...
            finally
            {
                ...
                if (handlerLogger != null)
                {
                    handlerLogger.Write(true, String.Format("The uplift calculation ended at {0:yyyy-MM-dd HH:mm:ss}. Duration: {1} second", DateTimeOffset.Now, 1/*, sw.Elapsed.TotalSeconds*/));
                }
            }
        }
