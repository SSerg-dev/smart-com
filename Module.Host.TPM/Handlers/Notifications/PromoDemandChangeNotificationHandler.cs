...
{
    /// <summary>
    /// Класс для запуска экшена по формированияю и отправке уведомлений по Promo Demand Change
    /// </summary>
    public class PromoDemandChangeNotificationHandler : BaseHandler {
        public override void Action(HandlerInfo info, ExecuteData data) {
            ...
            try {
                ...
                IAction action = new PromoDemandChangeNotificationAction();
                action.Execute();
