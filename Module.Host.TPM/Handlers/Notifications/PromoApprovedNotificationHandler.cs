...
{
	/// <summary>
	/// Класс для запуска экшена по формированияю и отправке уведомлений при смене статуса промо на Approved 
	/// </summary>
	public class PromoApprovedNotificationHandler : BaseHandler
    {
        public override void Action(HandlerInfo info, ExecuteData data)
        {
            ...
            try
            {
                ...
                IAction action = new PromoApprovedNotificationAction();
                action.Execute();
