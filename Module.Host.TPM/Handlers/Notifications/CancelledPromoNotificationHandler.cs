...
{
    /// <summary>
    /// Класс для запуска экшена по формированияю и отправке уведомлений по Cancelled Promo
    /// </summary>
    public class CancelledPromoNotificationHandler : BaseHandler
    {
        public override void Action(HandlerInfo info, ExecuteData data)
        {
            ...
            try
            {
                ...
                IAction action = new CancelledPromoNotificationAction();
                action.Execute();
