...
{
    /// <summary>
    /// Класс для запуска экшена по формированияю и отправке уведомления об ошибках при синхронизации продуктов с таблицей Materials
    /// </summary>
    public class ProductSyncFailNotificationHandler : BaseHandler
    {
