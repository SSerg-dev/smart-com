...
{
    /// <summary>
    /// Класс для запуска экшена по формированияю и отправке уведомлений о необходимости создания нового клиента
    /// </summary>
    public class ClientTreeNeedUpdateNotificationHandler : BaseHandler
    {
        public override void Action(HandlerInfo info, ExecuteData data)
        {
            ...
            try
            {
                ...
                IAction action = new ClientTreeNeedUpdateNotificationAction();
                action.Execute();
