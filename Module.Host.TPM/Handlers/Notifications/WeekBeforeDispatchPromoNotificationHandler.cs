...
{
    /// <summary>
    /// Класс для запуска экшена по формированияю и отправке уведомлений Promo с неделей до Dispatch start
    /// </summary>
    public class WeekBeforeDispatchPromoNotificationHandler : BaseHandler
    {
        public override void Action(HandlerInfo info, ExecuteData data)
        {
            ...
            try
            {
                ...
                IAction action = new WeekBeforeDispatchPromoNotificationAction();
                action.Execute();
