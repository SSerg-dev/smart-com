...
SELECT
	...
	(CASE WHEN (dbo.ClientDashboardGetYTDwithShare(SUM(YEE.YTD_LSV), SUM(SHARES.Share)) != 0)
		THEN (CASE WHEN (SUM(pp.ActualPromoTIMarketing) + SUM(pp.PlanPromoTIMarketingFinished) IS NULL) 
				THEN 0 ELSE SUM(pp.ActualPromoTIMarketing) + SUM(pp.PlanPromoTIMarketingFinished) END
			+ CASE WHEN (MAX(np.ActualCostTE) + MAX(np.PlanCostTEYTD) IS NULL) 
				THEN 0 ELSE MAX(np.ActualCostTE) + MAX(np.PlanCostTEYTD) END) / dbo.ClientDashboardGetYTDwithShare(SUM(YEE.YTD_LSV), SUM(SHARES.Share)) * 100
	...
	(CASE WHEN (dbo.ClientDashboardGetYTDwithShare(SUM(YEE.YEE_LSV), SUM(SHARES.Share)) != 0)
		THEN (CASE WHEN (SUM(pp.ActualPromoTIMarketing) + SUM(pp.PlanPromoTIMarketing) IS NULL) 
				THEN 0 ELSE SUM(pp.ActualPromoTIMarketing) + SUM(pp.PlanPromoTIMarketing) END
			+ CASE WHEN (MAX(np.ActualCostTE) + MAX(np.PlanCostTEYEE) IS NULL) 
				THEN 0 ELSE MAX(np.ActualCostTE) + MAX(np.PlanCostTEYEE) END) / dbo.ClientDashboardGetYTDwithShare(SUM(YEE.YEE_LSV), SUM(SHARES.Share)) * 100
	...
	(CASE WHEN (dbo.ClientDashboardGetYTDwithShare(SUM(YEE.YTD_LSV), SUM(SHARES.Share)) != 0 
		...
		THEN ((SUM(pp.ActualPromoTIMarketing) + SUM(pp.PlanPromoTIMarketingFinished))/dbo.ClientDashboardGetYTDwithShare(SUM(YEE.YTD_LSV), SUM(SHARES.Share))) * 100
	...
	(CASE WHEN (dbo.ClientDashboardGetYTDwithShare(SUM(YEE.YEE_LSV), SUM(SHARES.Share)) != 0
		...
		THEN ((SUM(pp.ActualPromoTIMarketing) + SUM(pp.PlanPromoTIMarketing))/(dbo.ClientDashboardGetYTDwithShare(SUM(YEE.YEE_LSV), SUM(SHARES.Share)))) * 100
	...
	(CASE WHEN (dbo.ClientDashboardGetYTDwithShare(SUM(YEE.YTD_LSV), SUM(SHARES.Share)) != 0  
		...
		THEN ((MAX(np.ActualCostTE) + MAX(np.PlanCostTEYTD))/dbo.ClientDashboardGetYTDwithShare(SUM(YEE.YTD_LSV), SUM(SHARES.Share))) * 100
	...
	(CASE WHEN (dbo.ClientDashboardGetYTDwithShare(SUM(YEE.YEE_LSV), SUM(SHARES.Share)) != 0
		...
		THEN ((MAX(np.ActualCostTE) + MAX(np.PlanCostTEYEE))/(dbo.ClientDashboardGetYTDwithShare(SUM(YEE.YEE_LSV), SUM(SHARES.Share)))) * 100
