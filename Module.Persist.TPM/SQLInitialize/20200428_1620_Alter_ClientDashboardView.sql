...
SELECT
	...
	CASE WHEN (dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YTD_LSV), MAX(SHARES.Share)) != 0)
		...
		THEN (SUM(pp.ActualPromoLSV) + SUM(pp.PlanPromoLSVFinished))/(dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YTD_LSV), MAX(SHARES.Share))) ELSE 0 END AS VodYTD,
	CASE WHEN (SUM(pp.ActualPromoLSV) + SUM(pp.PlanPromoLSV)) != 0 AND (SUM(pp.ActualPromoLSV) + SUM(pp.PlanPromoLSV)) IS NOT NULL 
			AND dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YEE_LSV), MAX(SHARES.Share)) != 0
		THEN (SUM(pp.ActualPromoLSV) + SUM(pp.PlanPromoLSV))/dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YEE_LSV), MAX(SHARES.Share)) ELSE 0 END AS VodYEE,
	...
	(CASE WHEN (dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YTD_LSV), MAX(SHARES.Share)) != 0 
		...
		THEN ((SUM(pp.ActualPromoTIShopper) + SUM(pp.PlanPromoTIShopperFinished))/dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YTD_LSV), MAX(SHARES.Share))) * 100
	...
	CASE WHEN (SUM(pp.ActualPromoTIShopper) + SUM(pp.PlanPromoTIShopper) IS NULL) 
		...
		-- YEE / YEE with Share
	(CASE WHEN (dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YEE_LSV), MAX(SHARES.Share)) != 0
		...
		THEN ((SUM(pp.ActualPromoTIShopper) + SUM(pp.PlanPromoTIShopper))/(dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YEE_LSV), MAX(SHARES.Share)))) * 100
	...
	(CASE WHEN (dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YTD_LSV), MAX(SHARES.Share)) != 0)
		THEN (CASE WHEN (SUM(pp.ActualPromoTIMarketing) + SUM(pp.PlanPromoTIMarketingFinished) IS NULL) 
				THEN 0 ELSE SUM(pp.ActualPromoTIMarketing) + SUM(pp.PlanPromoTIMarketingFinished) END
			+ CASE WHEN (MAX(np.ActualCostTE) + MAX(np.PlanCostTEYTD) IS NULL) 
				THEN 0 ELSE MAX(np.ActualCostTE) + MAX(np.PlanCostTEYTD) END) / dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YTD_LSV), MAX(SHARES.Share)) * 100
	...
	(CASE WHEN (dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YEE_LSV), MAX(SHARES.Share)) != 0)
		THEN (CASE WHEN (SUM(pp.ActualPromoTIMarketing) + SUM(pp.PlanPromoTIMarketing) IS NULL) 
				THEN 0 ELSE SUM(pp.ActualPromoTIMarketing) + SUM(pp.PlanPromoTIMarketing) END
			+ CASE WHEN (MAX(np.ActualCostTE) + MAX(np.PlanCostTEYEE) IS NULL) 
				THEN 0 ELSE MAX(np.ActualCostTE) + MAX(np.PlanCostTEYEE) END) / dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YEE_LSV), MAX(SHARES.Share)) * 100
	...
	(CASE WHEN (dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YTD_LSV), MAX(SHARES.Share)) != 0 
		...
		THEN ((SUM(pp.ActualPromoTIMarketing) + SUM(pp.PlanPromoTIMarketingFinished))/dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YTD_LSV), MAX(SHARES.Share))) * 100
	...
	(CASE WHEN (dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YEE_LSV), MAX(SHARES.Share)) != 0
		...
		THEN ((SUM(pp.ActualPromoTIMarketing) + SUM(pp.PlanPromoTIMarketing))/(dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YEE_LSV), MAX(SHARES.Share)))) * 100
	...
	(CASE WHEN (dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YTD_LSV), MAX(SHARES.Share)) != 0  
		...
		THEN ((MAX(np.ActualCostTE) + MAX(np.PlanCostTEYTD))/dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YTD_LSV), MAX(SHARES.Share))) * 100
	...
	(CASE WHEN (dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YEE_LSV), MAX(SHARES.Share)) != 0
		...
		THEN ((MAX(np.ActualCostTE) + MAX(np.PlanCostTEYEE))/(dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YEE_LSV), MAX(SHARES.Share)))) * 100
	...
	(CASE WHEN (dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YTD_LSV), MAX(SHARES.Share)) != 0
		...
		THEN ((SUM(pp.ActualPromoCostProduction) + SUM(pp.PlanPromoCostProductionFinished))/dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YTD_LSV), MAX(SHARES.Share)) * 100)
	...
	(CASE WHEN (dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YEE_LSV), MAX(SHARES.Share)) != 0
		...
		THEN ((SUM(pp.ActualPromoCostProduction) + SUM(pp.PlanPromoCostProduction))/(dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YEE_LSV), MAX(SHARES.Share)))) * 100
	...
	(CASE WHEN (dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YTD_LSV), MAX(SHARES.Share)) != 0
		...
		THEN ((SUM(pp.ActualPromoBranding) + SUM(pp.PlanPromoBrandingFinished))/dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YTD_LSV), MAX(SHARES.Share))) * 100
	...
	(CASE WHEN (dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YEE_LSV), MAX(SHARES.Share)) != 0
		...
		THEN ((SUM(pp.ActualPromoBranding) + SUM(pp.PlanPromoBranding))/(dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YEE_LSV), MAX(SHARES.Share)))) * 100
	...
	(CASE WHEN (dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YTD_LSV), MAX(SHARES.Share)) != 0 
		...
		THEN ((SUM(pp.ActualPromoBTL) + SUM(pp.PlanPromoBTLFinished))/dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YTD_LSV), MAX(SHARES.Share))) * 100
	...
	(CASE WHEN (dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YEE_LSV), MAX(SHARES.Share)) != 0
		...
		THEN ((SUM(pp.ActualPromoBTL) + SUM(pp.PlanPromoBTL))/dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YEE_LSV), MAX(SHARES.Share)) * 100)
	...
	CASE WHEN (MAX(CD.PlanLSV) IS NULL) THEN 0 ELSE MAX(CD.PlanLSV) END AS LSVPlan,
		-- YTD with Share
	dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YTD_LSV), MAX(SHARES.Share)) AS LSVYTD,
		-- YEE with Share
	dbo.ClientDashboardGetYTDwithShare(MAX(YEE.YEE_LSV), MAX(SHARES.Share)) AS LSVYEE,
	/* Incremental NSV */
		-- From ClientDashboard
