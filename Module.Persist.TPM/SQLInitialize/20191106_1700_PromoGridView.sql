ALTER VIEW [dbo].[PromoGridView] AS  SELECT 
				  ...
				  CAST(Round((CAST(pr.PlanPromoUpliftPercent AS DECIMAL(18, 3))), 2) AS FLOAT) AS PlanPromoUpliftPercent, 
				  ...
				  pr.InOut, 
				  CAST(Round((CAST((pr.PlanPromoIncrementalLSV / 1000000.0) AS DECIMAL(18, 3))), 2) AS FLOAT) AS PlanPromoIncrementalLSV,
				  CAST(Round((CAST((pr.PlanPromoBaselineLSV / 1000000.0) AS DECIMAL(18, 3))), 2) AS FLOAT) AS PlanPromoBaselineLSV,			  
				  pr.LastChangedDate, 
				  pr.LastChangedDateFinance, 
				  pr.LastChangedDateDemand,
