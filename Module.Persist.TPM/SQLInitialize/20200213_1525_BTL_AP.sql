...
INSERT INTO AccessPointRole
(Id, RoleId, AccessPointId)
SELECT NEWID(), (SELECT ID FROM [Role] Where SystemName = 'DemandFinance' AND [Disabled] = 'false'), Id FROM ACCESSPOINT WHERE [Resource]='BTLs' AND [Action] IN ('GetBTLs', 'GetBTL', 'Patch', 'ExportXLSX', 'FullImportXLSX', 'DownloadTemplateXLSX', 'Put', 'Post', 'Delete');
--Historical 
INSERT INTO AccessPointRole
(Id, RoleId, AccessPointId)
...
INSERT INTO AccessPointRole
(Id, RoleId, AccessPointId)
SELECT NEWID(), (SELECT ID FROM [Role] Where SystemName = 'CustomerMarketing' AND [Disabled] = 'false'), Id FROM ACCESSPOINT WHERE [Resource]='BTLs' AND [Action] IN ('GetBTLs', 'GetBTL', 'ExportXLSX'); 
--Historical 
INSERT INTO AccessPointRole
(Id, RoleId, AccessPointId)
...
INSERT INTO AccessPointRole
(Id, RoleId, AccessPointId)
SELECT NEWID(), (SELECT ID FROM [Role] Where SystemName = 'CMManager' AND [Disabled] = 'false'), Id FROM ACCESSPOINT WHERE [Resource]='BTLs' AND [Action] IN ('GetBTLs', 'GetBTL', 'ExportXLSX'); 
--Historical 
INSERT INTO AccessPointRole
(Id, RoleId, AccessPointId)
...
INSERT INTO AccessPointRole
(Id, RoleId, AccessPointId)
SELECT NEWID(), (SELECT ID FROM [Role] Where SystemName = 'KeyAccountManager' AND [Disabled] = 'false'), Id FROM ACCESSPOINT WHERE [Resource]='BTLs' AND [Action] IN ('GetBTLs', 'GetBTL', 'ExportXLSX'); 
--Historical 
INSERT INTO AccessPointRole
(Id, RoleId, AccessPointId)
...
INSERT INTO AccessPointRole
(Id, RoleId, AccessPointId)
SELECT NEWID(), (SELECT ID FROM [Role] Where SystemName = 'SuperReader' AND [Disabled] = 'false'), Id FROM ACCESSPOINT WHERE [Resource]='DeletedBTLs' AND [Action] IN ('GetDeletedBTLs');
