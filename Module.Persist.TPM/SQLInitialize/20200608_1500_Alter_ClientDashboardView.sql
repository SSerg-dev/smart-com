...
AS BEGIN
	...
	WHILE ((@GHierarchy IS NULL OR @GHierarchy = '') AND @ParentId IS NOT NULL AND @ParentId != 5000000) BEGIN
...
AS
	(SELECT 
		BrandTech.Id AS BTId, BrandTech.[Name] AS BTName, [BrandTech_code] AS BTCode, BrandId AS BrandId,
...
SELECT
	...
	MIN(BTCT.BTName) AS BrandTechName, 
	-- TODO: replace with join
