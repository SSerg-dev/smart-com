...
SELECT
	...
	/* Shopper TI */
	CASE WHEN (MAX(CD.ShopperTiPlanPercent) IS NULL) THEN 0 ELSE MAX(CD.ShopperTiPlanPercent) * 100 END AS ShopperTiPlanPercent,
	CASE WHEN (SUM(pp.TotalPlanPromoTIShopper) IS NULL) THEN 0 ELSE SUM(pp.TotalPlanPromoTIShopper) END AS ShopperTiPlan,
	CASE WHEN (SUM(pp.TotalPlanPromoTIShopper) IS NULL OR SUM(YEE.PlanLSV) IS NULL)
		THEN 0 ELSE (SUM(pp.TotalPlanPromoTIShopper) * SUM(YEE.PlanLSV)) END AS ShopperTiPlanKPIData,
	...
	/* Marketing TI */
	CASE WHEN (MAX(CD.MarketingTiPlanPercent) IS NULL) THEN 0 ELSE MAX(CD.MarketingTiPlanPercent) * 100 END AS MarketingTiPlanPercent,
	CASE WHEN (SUM(pp.TotalPlanPromoTIMarketing) IS NULL) THEN 0 ELSE SUM(pp.TotalPlanPromoTIMarketing) END AS MarketingTiPlan,
	CASE WHEN (SUM(pp.TotalPlanPromoTIMarketing) IS NULL OR SUM(YEE.PlanLSV) IS NULL)
		THEN 0 ELSE (SUM(pp.TotalPlanPromoTIMarketing) * SUM(YEE.PlanLSV)) END AS MarketingTiPlanKPIData,
	...
	/* Branding */
	CASE WHEN (SUM(YEE.PlanLSV) IS NULL OR SUM(YEE.PlanLSV) = 0) THEN 0 ELSE (CASE WHEN (MAX(CD.BrandingPlan)/SUM(YEE.PlanLSV)) IS NULL THEN 0 ELSE MAX(CD.BrandingPlan)/SUM(YEE.PlanLSV) END) END AS BrandingPlanPercent,
	...
	/* BTL */
	CASE WHEN (SUM(YEE.PlanLSV) IS NULL OR SUM(YEE.PlanLSV) = 0) THEN 0 ELSE (CASE WHEN (MAX(CD.BTLPlan)/SUM(YEE.PlanLSV)) IS NULL THEN 0 ELSE MAX(CD.BTLPlan)/SUM(YEE.PlanLSV) END) END AS BTLPlanPercent,
