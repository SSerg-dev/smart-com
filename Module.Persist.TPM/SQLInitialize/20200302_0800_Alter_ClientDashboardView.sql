...
SELECT
	...
	CASE WHEN (SUM(pp.ActualPromoCostProdCatalogue) IS NULL) THEN 0 ELSE SUM(pp.ActualPromoCostProdCatalogue) END AS ProdCatalogueYTD,
	CASE WHEN (SUM(pp.ActualPromoCostProdPOSMInClient) IS NULL) THEN 0 ELSE SUM(pp.ActualPromoCostProdPOSMInClient) END AS ProdPOSMInClientYTD,
