...
INSERT INTO AccessPointRole
(Id, RoleId, AccessPointId)
SELECT NEWID(), (SELECT ID FROM [Role] Where SystemName = 'FunctionalExpert' AND [Disabled] = 'false'), Id FROM ACCESSPOINT WHERE [Resource]='CoefficientSI2SOs' AND [Action] IN ('GetCoefficientSI2SOs', 'GetCoefficientSI2SO', 'ExportXLSX', 'Post', 'Put', 'Patch', 'Delete', 'FullImportXLSX', 'DownloadTemplateXLSX');
--Deleted
INSERT INTO AccessPointRole
(Id, RoleId, AccessPointId)
SELECT NEWID(), (SELECT ID FROM [Role] Where SystemName = 'FunctionalExpert' AND [Disabled] = 'false'), Id FROM ACCESSPOINT WHERE [Resource]='DeletedCoefficientSI2SOs' AND [Action] IN ('GetDeletedCoefficientSI2SOs');
--Historical
INSERT INTO AccessPointRole
(Id, RoleId, AccessPointId)
SELECT NEWID(), (SELECT ID FROM [Role] Where SystemName = 'FunctionalExpert' AND [Disabled] = 'false'), Id FROM ACCESSPOINT WHERE [Resource]='HistoricalCoefficientSI2SOs' AND [Action] IN ('GetHistoricalCoefficientSI2SOs');
...
INSERT INTO AccessPointRole
(Id, RoleId, AccessPointId)
SELECT NEWID(), (SELECT ID FROM [Role] Where SystemName = 'CustomerMarketing' AND [Disabled] = 'false'), Id FROM ACCESSPOINT WHERE [Resource]='CoefficientSI2SOs' AND [Action] IN ('GetCoefficientSI2SOs', 'GetCoefficientSI2SO', 'ExportXLSX', 'Post', 'Put', 'Patch', 'Delete', 'FullImportXLSX', 'DownloadTemplateXLSX'); 
--Deleted
INSERT INTO AccessPointRole
(Id, RoleId, AccessPointId)
SELECT NEWID(), (SELECT ID FROM [Role] Where SystemName = 'CustomerMarketing' AND [Disabled] = 'false'), Id FROM ACCESSPOINT WHERE [Resource]='DeletedCoefficientSI2SOs' AND [Action] IN ('GetDeletedCoefficientSI2SOs');
--Historical
INSERT INTO AccessPointRole
(Id, RoleId, AccessPointId)
SELECT NEWID(), (SELECT ID FROM [Role] Where SystemName = 'CustomerMarketing' AND [Disabled] = 'false'), Id FROM ACCESSPOINT WHERE [Resource]='HistoricalCoefficientSI2SOs' AND [Action] IN ('GetHistoricalDeletedCoefficientSI2SOs');


-- SuperReader
INSERT INTO AccessPointRole
(Id, RoleId, AccessPointId)
SELECT NEWID(), (SELECT ID FROM [Role] Where SystemName = 'SuperReader' AND [Disabled] = 'false'), Id FROM ACCESSPOINT WHERE [Resource]='CoefficientSI2SOs' AND [Action] IN ('GetCoefficientSI2SOs', 'GetCoefficientSI2SO', 'ExportXLSX', 'Post', 'Put', 'Patch', 'Delete', 'FullImportXLSX', 'DownloadTemplateXLSX'); 
--Deleted
INSERT INTO AccessPointRole
(Id, RoleId, AccessPointId)
