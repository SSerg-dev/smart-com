...
DELETE FROM AccessPointRole WHERE AccessPointId in (SELECT Id FROM ACCESSPOINT WHERE [Resource]='NonPromoEquipments' AND [Action] IN ('GetNonPromoEquipments', 'GetNonPromoEquipment', 'Patch', 'ExportXLSX', 'FullImportXLSX', 'DownloadTemplateXLSX', 'Put', 'Post', 'Delete'));
Delete FROM AccessPoint WHERE [Resource]='NonPromoEquipments' AND [Action] IN ('GetNonPromoEquipments', 'GetNonPromoEquipment', 'Patch', 'ExportXLSX', 'FullImportXLSX', 'DownloadTemplateXLSX', 'Put', 'Post', 'Delete') AND [Disabled] = 'false';
