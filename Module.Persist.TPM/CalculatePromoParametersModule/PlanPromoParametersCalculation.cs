                    ...
                    if (message == null)
                    {
                        ...
                        if (!promo.InOut.HasValue || !promo.InOut.Value)
                        {
                            ...
                            if (clientTree != null)
                            {
                                ...
                                if (promo.PromoPriceIncrease != null)
                                {
                                    promo.PromoPriceIncrease.PlanPromoPostPromoEffectLSVW1 = promo.PromoPriceIncrease.PlanPromoBaselineLSV * clientTree.PostPromoEffectW1 / 100;
                                    promo.PromoPriceIncrease.PlanPromoPostPromoEffectLSVW2 = promo.PromoPriceIncrease.PlanPromoBaselineLSV * clientTree.PostPromoEffectW2 / 100;
