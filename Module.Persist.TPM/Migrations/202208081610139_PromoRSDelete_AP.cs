namespace Module.Persist.TPM.Migrations
{
    ...
    public partial class PromoRSDelete_AP : DbMigration
    {
        ...
        private string SqlString = @"    
                ...
                (@RoleId, (SELECT[Id] FROM [DefaultSchemaSetting].[AccessPoint] where [Resource]='Promoes' and [Action]='PromoRSDelete'))
                GO
