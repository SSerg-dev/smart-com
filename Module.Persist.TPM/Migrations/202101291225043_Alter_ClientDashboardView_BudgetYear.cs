namespace Module.Persist.TPM.Migrations
{
    ...
    public partial class Alter_ClientDashboardView_BudgetYear : DbMigration
    {
		...
		@"
			...
			LEFT JOIN [DefaultSchemaSetting].[ClientTreeBrandTech] AS SHARES (NOLOCK) ON BTCT.CTId = SHARES.ClientTreeId AND 
