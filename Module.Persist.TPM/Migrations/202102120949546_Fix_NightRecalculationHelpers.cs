namespace Module.Persist.TPM.Migrations
{
    ...
    public partial class Fix_NightRecalculationHelpers : DbMigration
    {
        public override void Up()
        {
            ...
            {
                Sql($@"
                    {DropColumnUseActualCOGSTI}
                    go
                    {AddColumnUseActualTI}
                    go
                    {AddColumnUseActualCOGS}
                    go
        ...
        public override void Down()
        {
			...
			{
				Sql($@"
                    {DropColumnUseActualTI}
                    go
                    {DropColumnUseActualCOGS}
                    go
                    {DownProcUpdatePromo}
                    go
                ");
        ...
        private string DropColumnUseActualCOGSTI =
        @"
            if exists (
                select * from INFORMATION_SCHEMA.COLUMNS where TABLE_NAME = 'TEMP_PROMO' and COLUMN_NAME = 'UseActualCOGSTI'
            )
            alter table Jupiter.TEMP_PROMO drop column UseActualCOGSTI
        ";

        private string AddColumnUseActualTI =
        @"
            if not exists (
		...
		@"
            ...
            alter table Jupiter.TEMP_PROMO drop column UseActualTI
        ";

		private string DropColumnUseActualCOGS =
		@"
            if exists (
                select * from INFORMATION_SCHEMA.COLUMNS where TABLE_NAME = 'TEMP_PROMO' and COLUMN_NAME = 'UseActualCOGS'
            )
            alter table Jupiter.TEMP_PROMO drop column UseActualCOGS
        ";
