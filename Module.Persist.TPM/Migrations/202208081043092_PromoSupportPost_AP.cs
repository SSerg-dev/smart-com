namespace Module.Persist.TPM.Migrations
{
    ...
    public partial class PromoSupportPost_AP : DbMigration
    {
        ...
        private string SqlString = @"    
				...
				(0, 'PromoSupportPromoes',	'PromoSupportPromoPost', 1)
                GO
                ...
                (@RoleId, (SELECT[Id] FROM [DefaultSchemaSetting].[AccessPoint] where [Resource]='PromoSupportPromoes' and [Action]='PromoSupportPromoPost'))
                GO
