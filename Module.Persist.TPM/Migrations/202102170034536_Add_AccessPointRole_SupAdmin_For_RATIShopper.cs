namespace Module.Persist.TPM.Migrations
{
    ...
    public partial class Add_AccessPointRole_SupAdmin_For_RATIShopper : DbMigration
    {
        ...
        private string SqlString = @"  
                ...
                (@RoleId, (SELECT[Id] FROM [DefaultSchemaSetting].[AccessPoint] where[Resource]= 'RATIShoppers' and[Action]= 'DownloadTemplateXLSX')),
                ...
                (@RoleId, (SELECT[Id] FROM [DefaultSchemaSetting].[AccessPoint] where[Resource]='RATIShoppers' and[Action]='Put')),
                (@RoleId, (SELECT[Id] FROM [DefaultSchemaSetting].[AccessPoint] where[Resource]='RATIShoppers' and[Action]='Post')),
                (@RoleId, (SELECT[Id] FROM [DefaultSchemaSetting].[AccessPoint] where[Resource]='RATIShoppers' and[Action]='Patch')),
                (@RoleId, (SELECT[Id] FROM [DefaultSchemaSetting].[AccessPoint] where[Resource]='RATIShoppers' and[Action]='Delete')),
                (@RoleId, (SELECT[Id] FROM [DefaultSchemaSetting].[AccessPoint] where[Resource]='RATIShoppers' and[Action]='ExportXLSX')),
                (@RoleId, (SELECT[Id] FROM [DefaultSchemaSetting].[AccessPoint] where[Resource]='RATIShoppers' and[Action]='FullImportXLSX')),
