namespace Module.Persist.TPM.Migrations
{
    ...
    public partial class BTLPromoDelete_AP : DbMigration
    {
        ...
        private string SqlString = @"    
                ...
                (@RoleId, (SELECT[Id] FROM [DefaultSchemaSetting].[AccessPoint] where [Resource]='BTLPromoes' and [Action]='BTLPromoDelete'))
                GO
