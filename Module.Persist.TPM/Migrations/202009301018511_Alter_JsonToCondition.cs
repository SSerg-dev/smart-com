namespace Module.Persist.TPM.Migrations
{
    ...
    public partial class Alter_JsonToCondition : DbMigration
    {
		...
		CREATE OR ALTER FUNCTION [DefaultSchemaSetting].[JsonToCondition]
		(
			@PKey NVARCHAR(MAX),
			@Filter NVARCHAR(MAX)
		)
		...
		BEGIN
			DECLARE 
				...
				@Pref NVARCHAR(MAX) = '[DefaultSchemaSetting].[Product].[';
