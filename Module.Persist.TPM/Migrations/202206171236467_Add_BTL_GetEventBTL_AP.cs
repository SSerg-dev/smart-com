namespace Module.Persist.TPM.Migrations
{
    ...
    public partial class Add_BTL_GetEventBTL_AP : DbMigration
    {
        ...
        private string SqlString = @"
                ...
                (@RoleId, (SELECT[Id] FROM [DefaultSchemaSetting].[AccessPoint] where [Resource]='BTLs' and [Action]='GetEventBTL'))
            GO
