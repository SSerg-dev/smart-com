namespace Module.Persist.TPM.Migrations
{
    ...
    public partial class PromoSupportDelete_AP : DbMigration
    {
        ...
        private string SqlString = @"    
				...
				(0, 'PromoSupportPromoes',	'PromoSupportPromoDelete', 1)
                GO
                ...
                (@RoleId, (SELECT[Id] FROM [DefaultSchemaSetting].[AccessPoint] where [Resource]='PromoSupportPromoes' and [Action]='PromoSupportPromoDelete'))
                GO
