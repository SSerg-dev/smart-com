...
$webConfAzurePath = "$CurrentPath\..\Frontend.TPM\Web.config.azure"

$appInsightConfWinPath = "$CurrentPath\..\Frontend.TPM\ApplicationInsights.config"
$appInsightConfAzurePath = "$CurrentPath\..\Frontend.TPM\ApplicationInsights.config.azure"

$appConfWinPath = "$CurrentPath\..\ProcessingService.TPM\App.config"
$appConfAzurePath = "$CurrentPath\..\ProcessingService.TPM\App.config.azure"

$appProjWinPath = "$CurrentPath\..\ProcessingService.TPM\ProcessingService.TPM.csproj"
$appProjAzurePath = "$CurrentPath\..\ProcessingService.TPM\ProcessingService.TPM.csproj.azure"

$appPersWinPath = "$CurrentPath\..\Module.Persist.TPM/app.config"
$appPersAzurePath = "$CurrentPath\..\Module.Persist.TPM/app.config.azure"
